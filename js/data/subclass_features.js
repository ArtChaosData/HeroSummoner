// Auto-generated from dnd.su — D&D 5e subclass features
// Source: https://dnd.su/class/ (PHB, XGtE, TCoE only — no UA/homebrew/other)

export const SUBCLASS_FEATURES = {
  'Бард': {
    'Коллегия доблести': {
      features: {
        3: ["ДОПОЛНИТЕЛЬНЫЕ НАВЫКИ", "БОЕВОЕ ВДОХНОВЕНИЕ"],
        6: ["ДОПОЛНИТЕЛЬНАЯ АТАКА"],
        14: ["БОЕВАЯ МАГИЯ"],
      },
      descriptions: {
        'ДОПОЛНИТЕЛЬНЫЕ НАВЫКИ': `3-й уровень, умение коллегии доблести
Присоединяясь к коллегии доблести, вы получаете владение средними доспехами, щитами и воинским оружием.`,
        'БОЕВОЕ ВДОХНОВЕНИЕ': `3-й уровень, умение коллегии доблести
Вы узнаёте, как вдохновлять других в бою. Существо, получившее от вас кость бардовского вдохновения, может бросить эту кость и добавить результат к своему броску урона оружием. В качестве альтернативы, если существо атаковано, оно может реакцией совершить бросок кости вдохновения и добавить результат к своему КД от этой атаки. Оно может сделать это после броска атаки, но до того, как узнает, попали ли по нему.`,
        'ДОПОЛНИТЕЛЬНАЯ АТАКА': `6-й уровень, умение коллегии доблести
Если вы в свой ход совершаете действие Атака, вы можете совершить две атаки вместо одной.`,
        'БОЕВАЯ МАГИЯ': `14-й уровень, умение коллегии доблести
Вы научились сплетать использование заклинаний и оружия в одно гармоничное действие. Если вы действием используете заклинание барда, вы можете бонусным действием совершить одну атаку оружием.`,
    ...
    'Коллегия знаний': {
      features: {
        3: ["ДОПОЛНИТЕЛЬНЫЕ НАВЫКИ", "ОСТРОЕ СЛОВЦО"],
        6: ["ДОПОЛНИТЕЛЬНЫЕ ТАЙНЫ МАГИИ"],
        14: ["НЕПРЕВЗОЙДЁННЫЙ НАВЫК"],
      },
      descriptions: {
        'ДОПОЛНИТЕЛЬНЫЕ НАВЫКИ': `3-й уровень, умение коллегии знаний
Если вы присоединяетесь к коллегии знаний, вы овладеваете тремя навыками на ваш выбор.`,
        'ОСТРОЕ СЛОВЦО': `3-й уровень, умение коллегии знаний
Вы узнаёте, как использовать собственное остроумие, чтобы отвлечь, смутить или по-другому подорвать способности и уверенность противников. Если существо, которое вы можете видеть, в пределах 60 футов от вас совершает бросок атаки, урона или проверку характеристики, вы можете реакцией потратить одну из ваших костей бардовского вдохновения, и вычесть результат броска этой кости из броска этого существа. Вы можете принять решение об использовании этого умения после броска существа, но до того момента, когда Мастер объявит результат броска или проверки. Существо не подвержено этому умению, если не может слышать вас, или обладает иммунитетом к очарованию.`,
        'ДОПОЛНИТЕЛЬНЫЕ ТАЙНЫ МАГИИ': `6-й уровень, умение коллегии знаний
Вы можете выучить 2 заклинания из доступных любому классу на свой выбор. Их уровень не должен превышать уровня заклинаний, которые вы можете использовать на этом уровне, как показано в таблице Барда. Они также могут быть заговорами. Выбранные заклинания теперь считаются для вас заклинаниями барда, но они не учитываются в общем количестве известных вам заклинаний барда.`,
        'НЕПРЕВЗОЙДЁННЫЙ НАВЫК': `14-й уровень, умение коллегии знаний
Если вы совершаете проверку характеристики, вы можете бросить кость бардовского вдохновения и добавить результат к проверке. Вы можете принять решение об использовании этого умения после броска проверки, но до того, как Мастер объявит результат этой проверки.`,
    ...
    'Коллегия мечей': {
      ...
      descriptions: {
        'БОЕВОЙ СТИЛЬ': `3-й уровень, умение коллегии мечей
...
Сражение двумя оружиями. Если вы сражаетесь двумя оружиями, вы можете добавить модификатор характеристики к урону от второй атаки.`,
        'ДОПОЛНИТЕЛЬНЫЕ ВЛАДЕНИЯ': `3-й уровень, умение коллегии мечей
Когда вы вступаете в Коллегию Мечей, вы получаете владение средними доспехами и скимитарами. Если вы владеете простым или воинским оружием ближнего боя, то можете использовать его в качестве фокусировки для ваших заклинаний барда.`,
        'росчерк КЛИНКа': `3-й уровень, умение коллегии мечей
...
Мобильный росчерк. Вы можете потратить одно свое «Вдохновение барда», чтобы оружие нанесло дополнительный урон по цели. Урон равен числу, выпавшему на кости бардовского вдохновения. Вы также можете оттолкнуть цель на 5 футов от себя, плюс количество футов, выпавшее на кости бардовского вдохновения. После этого вы незамедлительно можете реакцией переместиться на расстояние не большее своей скорости в незанятое место в 5 футах от цели.`,
        'ДОПОЛНИТЕЛЬНАЯ АТАКА': `6-й уровень, умение коллегии мечей
Если вы в свой ход совершаете действие Атака, вы можете совершить две атаки вместо одной.`,
        'МАСТЕРСКий Росчерк': `14-й уровень, умение коллегии мечей
Когда вы используете вариант «Росчерка клинка», вы можете совершить бросок к6 и использовать его вместо траты кости бардовского вдохновения.`,
    ...
    'Коллегия очарования': {
      ...
      descriptions: {
        'ЗАВОРАЖИВАЮЩЕЕ ВЫСТУПЛЕНИЕ': `3-й уровень, умение коллегии очарования
...
Использовав это умение, вы не можете использовать его повторно до окончания короткого или продолжительного отдыха.`,
        'МАНТИЯ ВДОХНОВЕНИЯ': `3-й уровень, умение коллегии очарования
...
Количество временных хитов увеличивается, когда вы достигаете определенных уровней в этом классе: до 8 на 5-м уровне, 11 на 10-м уровне и 14 на 15-м уровне.`,
        'МАНТИЯ ВЕЛИЧИЯ': `6-й уровень, умение коллегии очарования
...
Использовав это умение, вы не можете использовать его повторно до окончания продолжительного отдыха.`,
        'НЕСОКРУШИМОЕ ВЕЛИЧИЕ': `14-й уровень, умение коллегии очарования
...
Приняв этот величественный вид, вы не можете использовать его повторно до окончания короткого или продолжительного отдыха.`,
    ...
    'Коллегия шёпотов': {
      ...
      descriptions: {
        'ПСИХИЧЕСКИЕ КЛИНКИ': `3-й уровень, умение коллегии шёпотов
...
Использовав это умение, вы не можете использовать его повторно до окончания короткого или продолжительного отдыха.`,
        'МАНТИЯ ШЁПОТОВ': `6-й уровень, умение коллегии шёпотов
...
Когда вы ловите тень этим умением, вы не можете поймать другую тень, до окончания короткого или продолжительного отдыха.`,
        'ЗНАНИЕ ТЕНИ': `14-й уровень, умение коллегии шёпотов
...
Использовав это умение, вы не можете использовать его повторно до окончания короткого или продолжительного отдыха.`,
    ...
    'Коллегия созидания': {
      ...
      descriptions: {
        'Частица потенциала': `3-й уровень, умение коллегии созидания
...
Спасбросок. Сразу же после того, как существо бросает кость бардовского вдохновения и добавляет её к спасброску, частица исчезает со звуками мягкой музыки, в результате чего существо получает количество временных хитов, равное значению, выпавшему на кости бардовского вдохновения, плюс ваш модификатор Харизмы (минимум 1 временный хит).`,
        'Созидательное выступление': `3-й уровень, умение коллегии созидания
...
После того, как вы создадите предмет этим умением, вы не сможете сделать это снова, пока не закончите продолжительный отдых или не израсходуете ячейку заклинания 2-го уровня или выше, чтобы применить это умение снова. У вас может быть только один предмет, созданный этим умением, одновременно: если вы используете это действие снова, то предыдущий предмет немедленно исчезает. Максимально возможный размер предмета, который вы можете создать с помощью этого умения, увеличивается на одну категорию, когда вы достигаете 6-го уровня (Большой) и 14-го уровня (Огромный).`,
        'Оживляющее выступление': `6-й уровень, умение коллегии созидания
...
После того, как вы оживляете предмет с помощью этого умения, вы не можете сделать это снова, пока не закончите продолжительный отдых или не израсходуете ячейку заклинания 3-го уровня или выше, чтобы снова воспользоваться этим умением. Вы можете одновременно иметь только один предмет, пробуждённый этим умением. Если вы используете это действие и уже имеете танцующий предмет от этого умения, то первый из них мгновенно становится неодушевленным.`,
        'Крещендо созидания': `14-й уровень, умение коллегии созидания
...
Вы больше не ограничены стоимостью в зм при создании предметов с помощью умения «Созидательное выступление».`,
  ...
  'Варвар': {
    'Путь берсерка': {
      ...
      descriptions: {
        'БЕШЕНСТВО': `3-й уровень, умение пути берсерка
Находясь в состоянии ярости, вы можете впасть в бешенство. В этом случае, пока ваша ярость не прекратилась, вы можете в каждый свой ход после текущего совершать бонусным действием одну рукопашную атаку оружием. После окончания ярости вы получаете одну степень истощения.`,
        'БЕЗДУМНАЯ ЯРОСТЬ': `6-й уровень, умение пути берсерка
Вы не можете быть испуганы или очарованы, пока находитесь в состоянии ярости. Если вы были испуганы или очарованы до того, как впали в состояние ярости, эти эффекты приостанавливаются до окончания вашей ярости.`,
        'ПУГАЮЩЕЕ ПРИСУТСТВИЕ': `10-й уровень, умение пути берсерка
...
Эффект оканчивается, если цель оказалась вне линии обзора, или далее чем в 60 футах от вас. Если существо преуспело в спасброске, вы не можете использовать на нём это умение следующие 24 часа.`,
        'ОТВЕТНЫЙ УДАР': `14-й уровень, умение пути берсерка
...
Тигр (Источник «Sword Coast Adventurer’s Guide»). Пока вы находитесь в ярости, вы можете добавить 10 футов к дальности вашего прыжка в длину и 3 фута к прыжку в высоту. Дух тигра помогает вам набрасываться на врагов.`,
        'АСПЕКТ ЗВЕРЯ': `6-й уровень, умение пути тотемного воина
...
Тигр (Источник: «Sword Coast Adventurer’s Guide»). Вы получаете владение двумя из следующих навыков на выбор: Акробатика, Атлетика, Выживание или Скрытность. Дух тигра оттачивает ваше умение выживать.`,
        'ГУЛЯЮЩИЙ С ДУХАМИ': `10-й уровень, умение пути тотемного воина
Вы получаете возможность накладывать заклинание общение с природой [commune with nature] в качестве ритуала. Когда вы делаете это, призрачная версия одного из ваших тотемных животных является вам и сообщает необходимую информацию.`,
        'ГАРМОНИЯ ТОТЕМА': `14-й уровень, умение пути тотемного воина
...
Тигр (Источник: «Sword Coast Adventurer’s Guide»). Когда вы находитесь в состоянии ярости, при перемещении по прямой как минимум на 20 футов к цели Большого или меньшего размера и до совершения атаки рукопашным оружием, вы можете потратить бонусное действие на совершение дополнительной атаки рукопашным оружием по этому существу.`,
    ...
    'Путь буревестника': {
      ...
      descriptions: {
        'АУРА БУРИ': `3-й уровень, умение пути буревестника
...
Тундра. Когда активируется этот эффект, каждое существо по вашему выбору в пределах действия вашей ауры получает 2 временных хита, так как ледяные духи делают их менее чувствительными к страданиям. Количество временных хитов увеличивается, когда вы достигаете определенных уровней в этом классе: до 3 на 5-м уровне, 4 на 10-м уровне, 5 на 15-м уровне и 6 на 20-м уровне.`,
        'ДУША БУРИ': `6-й уровень, умение пути буревестника
...
Тундра. Вы получаете сопротивление урону холодом и не страдаете от эффектов сильного холода, описанных в «Руководстве Мастера». Более того, вы можете действием дотронуться до воды и превратить её в куб льда со стороной 5 футов, который растает через 1 минуту. Действие проваливается если в кубе находится существо.`,
        'ОГРАЖДАЮЩАЯ БУРЯ': `10-й уровень, умение пути буревестника
Вы учитесь использовать своё мастерство бури, чтобы защищать других. Каждое существо по вашему выбору получает сопротивление урону, которое вы получили от умения «Душа бури», пока существо находится в пределах действия вашей ауры бури.`,
        'НЕИСТОВСТВО БУРИ': `14-й уровень, умение пути буревестника
...
Тундра. Когда эффект вашей ауры бури активирован, вы можете выбрать одно существо, которое можете видеть в пределах действия ауры. Это существо должно преуспеть в спасброске Силы, иначе его скорость уменьшается до 0 до начала вашего следующего хода, так как его покрывает магический мороз.`,
    ...
    'Путь предка-хранителя': {
      ...
      descriptions: {
        'ДРЕВНИЕ ЗАЩИТНИКИ': `3-й уровень, умение пути предка-хранителя
...
До начала вашего следующего хода цель совершает броски атаки, которые не направлены на вас, с помехой, а когда цель попадает атакой по существу, отличному от вас, то существо имеет сопротивление урону, наносимому атакой. Эффект на цели заканчивается раньше, если ваша ярость заканчивается.`,
        'ЩИТ ПРЕДКОВ': `6-й уровень, умение пути предка-хранителя
...
Уменьшаемый урон изменяется, когда вы достигаете определённых уровней в этом классе: на 3к6 на 10-м уровне и на 4к6 на 14-м уровне.`,
        'СОВЕТ ПРЕДКОВ': `10-й уровень, умение пути предка-хранителя
...
Базовой характеристикой для этих заклинаний является ваша Мудрость. После того, как вы наложили любое из этих заклинаний таким образом, вы не можете сделать это вновь, пока не закончите короткий или продолжительный отдых.`,
        'МСТИТЕЛЬНЫЕ ПРЕДКИ': `14-й уровень, умение пути предка-хранителя
Ваши духи предков становятся достаточно могущественными, чтобы давать отпор. Когда вы используете свой «Щит предков», чтобы уменьшить урон от атаки, атакующий получает урон силовым полем в количестве, равном тому, которое отразил «Щит предков».`,
    ...
    'Путь фанатика': {
      ...
      descriptions: {
        'БОЖЕСТВЕННЫЙ ГНЕВ': `3-й уровень, умение пути фанатика
...
Вы самостоятельно выбираете тип урона при получении этого умения из урона излучением или некротической энергией.`,
        'ВОИН БОГОВ': `3-й уровень, умение пути фанатика
Ваша душа отмечена для вечной битвы. Если заклинание, такое как оживление [raise dead], имеет единственный эффект — вернуть вас к жизни (но не нежитью), заклинателю не требуются материальные компоненты, чтобы наложить его на вас.`,
        'КОНЦЕНТРАЦИЯ ФАНАТИКА': `6-й уровень, умение пути фанатика
...
Вы можете использовать эту способность только один раз в течение одной ярости.`,
        'ФАНАТИЧНОЕ ПРИСУТСТВИЕ': `10-й уровень, умение пути фанатика
...
Использовав это умение, вы не можете использовать его повторно до окончания продолжительного отдыха.`,
        'ЯРОСТЬ ПРЕВЫШЕ СМЕРТИ': `14-й уровень, умение пути фанатика
Божественная сила, что питает вашу ярость, позволяет вам игнорировать смертельные удары. Пока вы в ярости, опускание хитов до 0 не заставляет вас потерять сознание. Вы по-прежнему должны совершать спасброски от смерти, и наносимый вам урон имеет те же эффекты, что и урон, наносимый персонажу с 0 хитов. Но даже если вы должны умереть при провале спасбросков от смерти, вы не умрёте, пока не закончится ваша ярость, и в этом случае умрёте, только если у вас всё ещё будет 0 хитов.`,
    ...
    'Путь дикой магии': {
      features: {
        3: ["Магическая осведомлённость", "Всплеск дикости"],
        6: ["Поддерживающая магия"],
        10: ["Нестабильная отдача"],
        14: ["Контролируемый всплеск"],
      },
      descriptions: {
        'Магическая осведомлённость': `3-й уровень, умение пути дикой магии
...
Вы можете использовать это умение количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Всплеск дикости': `3-й уровень, умение пути дикой магии
...
Магический эффект
1
Вокруг вас вьются тёмные щупальца. Каждое существо по вашему выбору, которое вы можете видеть в пределах 30 футов от вас, должно преуспеть в спасброске Телосложения, иначе получит 1к12 урона некротической энергией. Вы также получаете 1к12 временных хитов.
2
...
3
В пределах 5 футов от одного существа по вашему выбору, которое вы можете видеть в пределах 30 футов, появляется неосязаемый дух, выглядящий как фламф [flumph] или пикси [pixie] (по вашему выбору). В конце текущего хода дух взрывается, и каждое существо в пределах 5 футов от него должно преуспеть в спасброске Ловкости, иначе получит 1к6 урона силовым полем. Пока ваша ярость не закончится, вы можете каждый свой ход бонусным действием применять этот эффект, вызывая нового духа.
4
Одно оружие в ваших руках по вашему выбору наполняет магия. Пока ваша ярость не закончится, оружие приобретает свойства «лёгкое» и «метательное» (дис. 20/60), и тип его урона изменяется на урон силовым полем. Если оружие покидает вашу руку, то оно снова появляется в вашей руке в конце этого хода.
5
Пока ваша ярость не закончится, всякий раз, когда существо попадает по вам броском атаки, в ответ на атаку из вас выплёскивается магия, и существо получает 1к6 урона силовым полем.
6
...
8
Из вашей груди вырывается луч света. Другое существо по вашему выбору, которое вы можете видеть в пределах 30 футов, должно преуспеть в спасброске Телосложения, иначе получит 1к6 урона излучением и станет ослеплённым до начала вашего следующего хода. Пока ваша ярость не закончится, вы можете каждый свой ход бонусным действием применять этот эффект.`,
        'Поддерживающая магия': `6-й уровень, умение пути дикой магии
...
Вы можете использовать это действие количество раз, равное вашему бонусу мастерства, и вы восстанавливаете все израсходованные использования, когда заканчиваете продолжительный отдых.`,
        'Нестабильная отдача': `10-й уровень, умение пути дикой магии
Когда вы подвергаетесь опасности под действием ярости, магия внутри вас может выплеснуться. Сразу же после того, как вы получаете урон или проваливаете спасбросок во время ярости, вы можете реакцией совершить бросок по таблице «Дикая магия» и применить соответствующий эффект немедленно. Этот эффект заменяет ваш текущий эффект дикой магии.`,
        'Контролируемый всплеск': `14-й уровень, умение пути дикой магии
Всякий раз, когда вы совершаете бросок по таблице «Дикая магия», вы можете бросить две кости и выбрать любой из двух эффектов. Если на костях выпало одинаковое значение, то вы можете проигнорировать его и выбрать любой эффект из таблицы.`,
    ...
    'Путь зверя': {
      ...
      descriptions: {
        'Форма зверя': `3-й уровень, умение пути зверя
...
Описание оружия Хвоста может запутать. В описании говорится о том, что КД от хвоста повышается, без дополнительных уточнений. Но подразумевается, что увеличение применяется только на одну атаку, которая и спровоцировала реакцию.`,
        'Звериная душа': `6-й уровень, умение пути зверя
...
Когда вы совершаете прыжок, вы можете совершить проверку Силы (Атлетика) и увеличить дальность прыжка на значение этой проверки. Вы можете совершить эту специальную проверку только один раз за ход.`,
        'Заразная ярость': `10-й уровень, умение пути зверя
...
Вы можете использовать это умение количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Зов охоты': `14-й уровень, умение пути зверя
...
Вы можете использовать это умение количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
  ...
  'Воин': {
    'Мастер боевых искусств': {
      ...
      descriptions: {
        'БОЕВОЕ ПРЕВОСХОДСТВО': `3-й уровень, умение мастера боевых искусств
...
Сложность спасброска приёма = 8 + ваш бонус мастерства + ваш модификатор Силы или Ловкости (на ваш выбор)`,
        'УЧЕНИК ВОЙНЫ': `3-й уровень, умение мастера боевых искусств
Вы осваиваете владение одним из ремесленных инструментов на ваш выбор.`,
        'ПОЗНАЙ СВОЕГО ВРАГА': `7-й уровень, умение мастера боевых искусств
...
Количество уровней в классе Воин (если есть)`,
        'УЛУЧШЕННОЕ БОЕВОЕ ПРЕВОСХОДСТВО': `10-й уровень, умение мастера боевых искусств
Ваша кость превосходства увеличивается до к10. На 18-м уровне — до к12.`,
        'НЕОСЛАБЕВАЮЩИЙ': `15-й уровень, умение мастера боевых искусств
Если вы совершаете бросок инициативы, не имея костей превосходства, вы получаете одну.`,
      },
    },
    'Мистический рыцарь': {
      features: {
        3: ["ИСПОЛЬЗОВАНИЕ ЗАКЛИНАНИЙ", "СВЯЗЬ С ОРУЖИЕМ"],
        7: ["БОЕВАЯ МАГИЯ"],
        10: ["МИСТИЧЕСКИЙ УДАР"],
        15: ["ВОЛШЕБНЫЙ РЫВОК"],
      ...
      descriptions: {
        'ИСПОЛЬЗОВАНИЕ ЗАКЛИНАНИЙ': `3-й уровень, умение мистического рыцаря
...
Модификатор броска атаки = ваш бонус мастерства + ваш модификатор Интеллекта`,
        'СВЯЗЬ С ОРУЖИЕМ': `3-й уровень, умение мистического рыцаря
...
У вас может быть не более двух привязанных оружий одновременно, и бонусным действием вы призываете их по одному. Если вы попытаетесь создать связь с третьим оружием, вам придётся разорвать связь с одним из первых двух.`,
        'БОЕВАЯ МАГИЯ': `7-й уровень, умение мистического рыцаря
Если вы действием накладываете заговор, вы можете бонусным действием совершить одну атаку оружием.`,
        'МИСТИЧЕСКИЙ УДАР': `10-й уровень, умение мистического рыцаря
Вы узнаёте, как с помощью удара оружием снизить сопротивляемость цели вашим заклинаниям. Если вы попадаете по существу атакой оружием, это существо совершает следующий спасбросок от вашего заклинания, использованного до конца вашего следующего хода, с помехой.`,
        'ВОЛШЕБНЫЙ РЫВОК': `15-й уровень, умение мистического рыцаря
Вы получаете возможность телепортироваться на 30 футов в свободное пространство, которое вы видите, когда используете «Всплеск действий». Вы можете телепортироваться до или после дополнительного действия.`,
        'УЛУЧШЕННАЯ БОЕВАЯ МАГИЯ': `18-й уровень, умение мистического рыцаря
Если вы действием накладываете заклинание, вы можете бонусным действием совершить одну атаку оружием.`,
    ...
    'Чемпион': {
      ...
      descriptions: {
        'УЛУЧШЕННЫЕ КРИТИЧЕСКИЕ ПОПАДАНИЯ': `3-й уровень, умение чемпиона
Ваши атаки оружием совершают критическое попадание при выпадении «19» или «20» на кости атаки.`,
        'ВЫДАЮЩИЙСЯ АТЛЕТ': `7-й уровень, умение чемпиона
...
Кроме того, если вы совершаете прыжок в длину с разбега, дальность прыжка увеличивается на количество футов, равное модификатору Силы.`,
        'ДОПОЛНИТЕЛЬНЫЙ БОЕВОЙ СТИЛЬ': `10-й уровень, умение чемпиона
На 10 уровне вы можете выбрать второй боевой стиль.`,
        'ПРЕВОСХОДНЫЕ КРИТИЧЕСКИЕ ПОПАДАНИЯ': `15-й уровень, умение чемпиона
Ваши атаки оружием совершают критическое попадание при выпадении «18–20» на кости атаки.`,
        'УЦЕЛЕВШИЙ': `18-й уровень, умение чемпиона
Вы достигаете вершин стойкости в бою. В начале каждого своего хода вы восстанавливаете количество хитов, равное 5 + ваш модификатор Телосложения, если количество ваших хитов не превышает половины от максимума. Это умение не работает, если у вас 0 хитов.`,
    ...
    'Кавалерист': {
      ...
      descriptions: {
        'ДОПОЛНИТЕЛЬНЫЕ ВЛАДЕНИЯ': `3-й уровень, умение кавалериста
...
В качестве альтернативы вы можете выучить один язык по вашему выбору.`,
        'НЕПОКОЛЕБИМАЯ МЕТКА': `3-й уровень, умение кавалериста
...
Независимо от количества существ, которых вы отметили, вы можете совершить эту специальную атаку количество раз, равное модификатору вашей Силы (минимум один), и восстанавливаете все потраченные атаки, после окончания продолжительного отдыха.`,
        'РОЖДЕННЫЙ В СЕДЛЕ': `3-й уровень, умение кавалериста
...
И наконец, забраться в седло и спешиться стоит вам всего 5 футов передвижения, а не половину скорости.`,
        'ЗАЩИТНЫЙ МАНЕВР': `7-й уровень, умение кавалериста
...
Вы можете использовать это умение количество раз, равное вашему модификатору Телосложения (минимум один), и восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'ДЕРЖАТЬ СТРОЙ': `10-й уровень, умение кавалериста
Вы становитесь мастером сдерживания своих противников. Вы можете совершить провоцированную атаку, если враждебное существо перемещается на 5 футов и более, оставаясь в пределах досягаемости. Для этого вы реакцией совершаете одну рукопашную атаку по спровоцировавшему существу, и если вы попадаете по нему такой атакой, его скорость уменьшается до 0 до конца текущего хода.`,
        'СВИРЕПЫЙ НАТИСК': `15-й уровень, умение кавалериста
...
Вы можете использовать это умение только один раз за ход.`,
        'БДИТЕЛЬНЫЙ ЗАЩИТНИК': `18-й уровень, умение кавалериста
...
Вы можете использовать эту реакцию только чтобы совершить провоцированную атаку и не можете использовать её в тот же ход, когда использовали свою нормальную реакцию.`,
    ...
    'Мистический лучник': {
      features: {
        3: ["ЗНАНИЯ МИСТИЧЕСКОГО ЛУЧНИКА", "МАГИЧЕСКИЙ ВЫСТРЕЛ"],
        7: ["ЗАЧАРОВАННАЯ СТРЕЛА", "СТРАНСТВУЮЩАЯ СТРЕЛА"],
        15: ["ВЫСТРЕЛ ВСЕГДА НАГОТОВЕ"],
      },
      descriptions: {
        'ЗНАНИЯ МИСТИЧЕСКОГО ЛУЧНИКА': `3-й уровень, умение мистического лучника
Вы учите некоторые природные секреты и магическую теорию – типичные для практиков этой военной эльфийской традиции. Вы получаете владение, по вашему выбору, навыком Магия или Природа, а также учите заговор фокусы [prestidigitation] или искусство друидов [druidcraft] .`,
        'МАГИЧЕСКИЙ ВЫСТРЕЛ': `3-й уровень, умение мистического лучника
...
Каждый вариант улучшается, когда вы становитесь воином 18-го уровня.`,
        'ЗАЧАРОВАННАЯ СТРЕЛА': `7-й уровень, умение мистического лучника
...
Когда вы стреляете немагической стрелой из короткого или длинного лука, вы можете сделать её магической с целью преодоления сопротивления и иммунитета к не магическим атакам и урону. Магия угасает в стреле сразу же после попадания или промаха по цели.`,
        'СТРАНСТВУЮЩАЯ СТРЕЛА': `7-й уровень, умение мистического лучника
Вы учитесь направлять сбившуюся стрелу к новой цели. Когда вы делаете бросок атаки магической стрелой и промахиваетесь, вы можете бонусным действием перебросить бросок атаки по другой цели, находящейся в пределах 60 футов от изначальной цели.`,
        'ВЫСТРЕЛ ВСЕГДА НАГОТОВЕ': `15-й уровень, умение мистического лучника
Ваше магическое мастерство всегда наготове в начале битвы. Если вы совершаете бросок инициативы, и у вас не осталось использований магического выстрела, вы восстанавливаете одно использование.`,
        'ВАРИАНТЫ МАГИЧЕСКОГО ВЫСТРЕЛА': `Умение «Магический выстрел» позволяет вам выбирать его варианты на определённых уровнях. В этом разделе представлены варианты в алфавитном порядке. Все эти эффекты магические, и каждый ассоциируется с одной из школ магии.
...
Урон психической энергией увеличивается до 4к6 когда вы достигаете 18-го уровня в этом классе.`,
    ...
    'Самурай': {
      features: {
        3: ["ДОПОЛНИТЕЛЬНЫЕ ВЛАДЕНИЯ", "БОЕВОЙ ДУХ"],
      ...
      descriptions: {
        'ДОПОЛНИТЕЛЬНЫЕ ВЛАДЕНИЯ': `3-й уровень, умение самурая
Вы получаете владение одним из следующих навыков по вашему выбору: Выступление, История, Проницательность или Убеждение. В качестве альтернативы вы можете выучить один язык по вашему выбору.`,
        'БОЕВОЙ ДУХ': `3-й уровень, умение самурая
...
Вы можете использовать это умение три раза. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'ЭЛЕГАНТНЫЙ ПРИДВОРНЫЙ': `7-й уровень, умение самурая
...
К тому же ваш самоконтроль позволил вам получить владением спасброском Мудрости. Если у вас уже есть владение спасброском Мудрости, вы получаете владение спасброском Интеллекта или Харизмы (по вашему выбору).`,
        'НЕУТОМИМАЯ ДУША': `10-й уровень, умение самурая
Когда вы совершаете бросок инициативы и у вас не осталось использований умения «Боевой дух», вы восстанавливаете одно использование.`,
        'СТРЕМИТЕЛЬНЫЙ УДАР': `15-й уровень, умение самурая
...
Вы не можете делать это более одного раза за ход.`,
        'СТОЙКОСТЬ ПЕРЕД СМЕРТЬЮ': `18-й уровень, умение самурая
...
Использовав это умение таким образом, вы не сможете сделать это вновь, пока не закончите продолжительный отдых.`,
    ...
    'Пси-воин': {
      ...
      descriptions: {
        'Псионическая сила': `3-й уровень, умение пси-воина
...
Телекинетическое передвижение. Вы можете передвинуть объект или существо при помощи силы разума. Действием вы нацеливаетесь на свободный объект Большого размера или меньше либо на одно согласное существо, отличное от вас. Если вы можете видеть цель и она находится в пределах 30 футов от вас, вы можете передвинуть её на расстояние до 30 футов в свободное пространство, которое вы можете видеть. В качестве альтернативы, если это Крошечный объект, вы можете переместить его к себе в руку или из своей руки. В любом случае вы можете перемещать объект горизонтально, вертикально или по обеим осям. Когда вы используете действие подобным образом, вы не сможете сделать это вновь, пока не закончите короткий или продолжительный отдых или не потратите кость псионической энергии на повторное использование этого умения.`,
        'Адепт-телекинетик': `7-й уровень, умение пси-воина
...
Телекинетический толчок. Когда вы наносите урон при помощи псионического удара, вы можете заставить цель совершить спасбросок Силы Сл 8 + ваш бонус мастерства + ваш модификатор Интеллекта. При провале вы можете сбить цель с ног, либо толкнуть её на расстояние вплоть до 10 футов в любом направлении по горизонтали.`,
        'Защищённый разум': `10-й уровень, умение пси-воина
Псионическая энергия, протекающая через вас, укрепила ваш разум. Вы получаете сопротивление урону психической энергией. Кроме того, если вы начинаете свой ход, будучи очарованным или испуганным, вы можете потратить кость псионической энергии и окончить на себе все эффекты, подвергающие вас этим состояниям.`,
        'Оплот силы': `15-й уровень, умение пси-воина
...
Когда вы используете бонусное действие подобным образом, вы не сможете сделать это вновь, пока не закончите короткий или продолжительный отдых или не потратите кость псионической энергии на повторное использование этого умения.`,
        'Мастер телекинеза': `18-й уровень, умение пси-воина
...
Когда вы используете это заклинание подобным образом, вы не сможете сделать это вновь, пока не закончите короткий или продолжительный отдых или не потратите кость псионической энергии на повторное использование этого умения.`,
    ...
    'Рунный рыцарь': {
      features: {
        3: ["Бонусные владения", "Резчик рун", "Мощь великана"],
        7: ["Рунический щит"],
        10: ["Великий рост"],
        15: ["Мастер рун"],
        18: ["Рунический джаггернаут"],
      },
      descriptions: {
        'Бонусные владения': `3-й уровень, умение рунного рыцаря
Вы получаете владение инструментами кузнеца, а также учитесь писать, читать и говорить на Великаньем языке.`,
        'Резчик рун': `3-й уровень, умение рунного рыцаря
...
Кроме того, бонусным действием вы можете пробудить силу этой руны и войти в пророческое состояние на 1 минуту или до тех пор, пока не станете недееспособны. Пока вы находитесь в этом состоянии, каждый раз, когда вы или любое другое существо в пределах 60 футов от вас совершаете бросок атаки, спасбросок или проверку характеристики, вы можете реакцией дать этому броску преимущество или помеху. Единожды пробудив руну, вы больше не сможете сделать этого до окончания короткого или продолжительного отдыха.`,
        'Мощь великана': `3-й уровень, умение рунного рыцаря
...
Вы можете использовать это умение количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Рунический щит': `7-й уровень, умение рунного рыцаря
...
Вы можете использовать это умение количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Великий рост': `10-й уровень, умение рунного рыцаря
...
Кроме того, дополнительный урон, который вы наносите умением «Мощь великана», увеличивается до 1к8.`,
        'Мастер рун': `15-й уровень, умение рунного рыцаря
Вы можете дважды пробуждать каждую из известных вам рун, полученных при помощи умения «Резчик рун», и восстанавливаете все потраченные пробуждения после окончания короткого или продолжительного отдыха.`,
        'Рунический джаггернаут': `18-й уровень, умение рунного рыцаря
...
Когда вы накладываете разрушительное заклинание, то можете создать относительно безопасные участки внутри зоны поражения, которые оно не затрагивает. При накладывании заклинания школы Воплощения, воздействующего на других существ, которых вы видите, вы можете выбрать количество существ, равное 1 + уровень заклинания. Выбранные существа автоматически преуспевают в спасбросках от этого заклинания и не получают урона, если по описанию должны получить половину урона от заклинания при успешном спасброске.`,
        'МОЩНЫЙ ЗАГОВОР': `6-й уровень, умение школы Воплощения
Ваши наносящие урон заговоры воздействуют даже на тех существ, которые избегают основного эффекта. Если существо преуспевает в спасброске от вашего заговора, оно получает половину урона от него (если есть), но не получает дополнительных эффектов от него.`,
        'УСИЛЕННОЕ ВОПЛОЩЕНИЕ': `10-й уровень, умение школы Воплощения
При броске урона от заклинания школы Воплощения волшебника, наложенного вами, вы добавляете к одному броску урона свой модификатор Интеллекта.`,
        'ПЕРЕГРУЗКА': `14-й уровень, умение школы Воплощения
...
Золото и время, которое вы тратите на копирование заклинания школы Вызова в свою книгу заклинаний, уменьшаются вдвое.`,
        'МАЛЫЙ ВЫЗОВ': `2-й уровень, умение школы Вызова
...
Предмет исчезает через 1 час, когда вы используете это умение вновь, или когда он получает или наносит любой урон.`,
        'БЕЗОПАСНОЕ ПЕРЕМЕЩЕНИЕ': `6-й уровень, умение школы Вызова
Вы можете действием телепортироваться на 30 футов в свободное пространство, которое можете видеть. В качестве альтернативы, вы можете выбрать пространство в пределах этого диапазона, занятое существом Маленького или Среднего размера. Если это существо согласно, вы оба телепортируетесь, меняясь местами. Использовав это умение один раз, вы не можете использовать его вновь до окончания продолжительного отдыха или пока не наложите заклинание школы Вызова 1-го уровня или выше.`,
        'ФОКУСИРОВАННЫЙ ВЫЗОВ': `10-й уровень, умение школы Вызова
Когда вы концентрируетесь на заклинании школы Вызова, ваша концентрация не может быть нарушена в результате получения урона.`,
        'НАДЁЖНЫЙ ПРИЗЫВ': `14-й уровень, умение школы Вызова
...
При накладывании заклинания малая иллюзия [minor illusion] вы можете использовать эффекты звука и изображения вместе единым заклинанием.`,
        'ПЛАСТИЧНЫЕ ИЛЛЮЗИИ': `6-й уровень, умение школы Иллюзии
Если вы наложили заклинание школы Иллюзии длительностью как минимум 1 минута, вы можете действием изменить характер этой иллюзии (используя обычные ограничения для этой иллюзии), при условии, что можете видеть эту иллюзию.`,
        'СОБСТВЕННАЯ ИЛЛЮЗОРНОСТЬ': `10-й уровень, умение школы Иллюзии
...
После использования данного умения вы должны закончить короткий или продолжительный отдых, прежде чем сможете воспользоваться им вновь.`,
        'ИЛЛЮЗОРНАЯ РЕАЛЬНОСТЬ': `14-й уровень, умение школы Иллюзии
...
Вы получаете возможность собирать жизненные силы существ, которых вы убиваете своими заклинаниями. Один раз за ход, когда вы убиваете одно или несколько существ заклинанием 1-го и более высокого уровня, вы восстанавливаете хиты в количестве, равном удвоенному уровню этого заклинания, или утроенному, если заклинание принадлежало школе Некромантии. Вы не получаете это преимущество, убивая Конструктов и Нежить.`,
        'НЕЖИВЫЕ РАБЫ': `6-й уровень, умение школы Некромантии
...
Создаваемые существа добавляют ваш бонус мастерства к броскам урона оружием.`,
        'ЕДИНЕНИЕ С НЕ-ЖИЗНЬЮ': `10-й уровень, умение школы Некромантии
Вы получаете сопротивление урону некротической энергией, и максимум ваших хитов уже не может уменьшаться. Вы провели так много времени в контакте с нежитью и оживляющей их энергией, что научились преодолевать их самые опасные побочные эффекты.`,
        'УПРАВЛЕНИЕ НЕЖИТЬЮ': `14-й уровень, умение школы Некромантии
...
Вы можете плести вокруг себя магию для защиты. Когда вы накладываете заклинание школы Ограждения 1-го уровня или выше, вы можете одновременно с этим использовать прядь магии для создания магической защиты, существующей до окончания продолжительного отдыха. Защита имеет максимальные хиты, равные вашему удвоенному уровню волшебника + модификатор Интеллекта. Когда вы получаете урон, его вместо вас получает защита. Если урон опускает хиты защиты до 0, то оставшийся после этого урон получаете вы. Когда у защиты остаётся 0 хитов, она не может поглощать урон, но её магия остаётся. Если вы накладываете заклинание школы Ограждения 1-го уровня или выше, защита восстанавливает количество хитов, равное удвоенному уровню заклинания. Единожды создав защиту, вы не можете создать её вновь, пока не закончите продолжительный отдых.`,
        'ПРОЕКЦИЯ ЗАЩИТЫ': `6-й уровень, умение школы Ограждения
Когда видимое вами существо, находящееся в пределах 30 футов от вас, получает урон, вы можете реакцией поглотить этот урон вашей «Магической защитой». Если урон опускает хиты защиты до 0, то защищаемое существо получает весь оставшийся урон.`,
        'УЛУЧШЕННОЕ ОГРАЖДЕНИЕ': `10-й уровень, умение школы Ограждения
Когда вы накладываете заклинание школы Ограждения, которое требует совершить проверку характеристики частью накладываемого заклинания (как в случае заклинаний контрзаклинание [counterspell] и рассеивание магии [dispel magic]), вы добавляете к этой проверке ваш бонус мастерства.`,
        'СОПРОТИВЛЕНИЕ ЗАКЛИНАНИЯМ': `14-й уровень, умение школы Ограждения
...
После окончания эффекта, или если существо успешно совершило спасбросок от него, вы не можете использовать данное умение против этого существа, пока не закончите продолжительный отдых.`,
        'ИНСТИНКТИВНОЕ ОЧАРОВАНИЕ': `6-й уровень, умение школы Очарования
...
Вы обязаны решить, будете ли использовать это умение, до того как будет известно, попала атака или промахнулась. Существа, которых нельзя очаровать, обладают иммунитетом к этому эффекту.`,
        'УСИЛЕННОЕ ОЧАРОВАНИЕ': `10-й уровень, умение школы Очарования
При накладывании вами заклинания школы Очарования 1-го уровня или выше, которое нацеливается только на одно существо, вы можете сделать целью второе существо.`,
        'ЛОЖНЫЕ ВОСПОМИНАНИЯ': `14-й уровень, умение школы Очарования
Вы получаете способность заставить существо забыть о магическом воздействии, которое вы на него оказали. При накладывании заклинания школы Очарования, которое очаровывает одно или несколько существ, вы можете изменить восприятие и воспоминания одного из них так, что оно забудет о том, что было очаровано. Кроме того, перед тем как заклинание развеется, вы можете действием попытаться заставить выбранное существо забыть некоторые моменты его пребывания в очарованном состоянии. Существо должно преуспеть в спасброске Интеллекта против Сл вашего заклинания волшебника, иначе оно потеряет воспоминания за промежуток времени, измеряемый в часах и равный 1 + ваш модификатор Харизмы (минимум 1). Вы можете заставить существо забыть меньшее количество времени. Количество забытого времени не может превышать продолжительность самого заклинания.`,
    ...
    'Школа Преобразования': {
      ...
      descriptions: {
        'МАСТЕР ПРЕОБРАЗОВАНИЯ': `2-й уровень, умение школы Преобразования
Золото и время, которое вы тратите на копирование заклинания школы Преобразования в свою книгу заклинаний, уменьшаются вдвое.`,
        'МАЛАЯ АЛХИМИЯ': `2-й уровень, умение школы Преобразования
Вы можете временно изменять физические свойства одного немагического предмета, превращая структуру вещества из одной в другую. Вы совершаете специальную алхимическую процедуру на одном предмете, состоящем полностью из дерева, камня (но не драгоценного камня), железа, меди или серебра, превращая его в один из этих материалов. За каждые 10 минут вы можете преобразовать до 1 кубического фута материала. Через 1 час, или когда вы теряете концентрацию (как если бы вы концентрировались на заклинании), материал возвратится в своё первоначальное состояние.`,
        'КАМЕНЬ ПРЕОБРАЗОВАНИЯ': `6-й уровень, умение школы Преобразования
...
Каждый раз, когда вы накладываете заклинание школы Преобразования 1-го уровня или выше, вы можете изменить эффект вашего камня, если он находится у вас. Если вы создаёте новый камень преобразования, предыдущий перестаёт работать.`,
        'ПЕРЕВЁРТЫШ': `10-й уровень, умение школы Преобразования
Вы добавляете заклинание превращение [polymorph] в свою книгу заклинаний, если его еще нет там. Вы можете накладывать превращение, не тратя ячейку заклинаний. Когда вы так поступаете, вы можете выбрать в качестве цели только себя и превратиться можете в Зверя, ПО которого не больше 1. Наложив превращение [polymorph] подобным путём один раз, вы не можете делать это еще раз до завершения короткого или продолжительного отдыха, хотя вы можете накладывать это заклинание обычным способом, за ячейки заклинаний.`,
        'ГЕНИЙ ПРЕОБРАЗОВАНИЯ': `14-й уровень, умение школы Преобразования
...
Каждый бросок предсказания может быть использован только один раз. Когда вы заканчиваете продолжительный отдых, вы теряете все неиспользованные броски предсказания.`,
        'ЭКСПЕРТ ПРОРИЦАНИЯ': `6-й уровень, умение школы Прорицания
Вы так легко накладываете заклинания школы Прорицания, что расходуете лишь малую часть своих сил. Когда вы накладываете заклинание школы Прорицания 2-го уровня или выше, используя ячейку заклинаний, вы восстанавливаете одну уже израсходованную ячейку заклинаний. Восстанавливаемая ячейка должна быть ниже уровнем, чем заклинание, которое вы накладываете, и не может быть выше 5-го уровня.`,
        'ТРЕТИЙ ГЛАЗ': `10-й уровень, умение школы Прорицания
...
Эфирный взгляд. Ваше зрение простирается на Эфирный план в пределах 60 футов.`,
        'ВЕЛИКОЕ ЗНАМЕНИЕ': `14-й уровень, умение школы Прорицания
Видения в ваших грёзах усиливаются и рисуют более точную картину того, что грядёт. Вы совершаете три броска к20 для вашего умения «Знамение» вместо двух.`,
    ...
    'Военная магия': {
      ...
      descriptions: {
        'МАГИЧЕСКОЕ ОТРАЖЕНИЕ': `2-й уровень, умение военной магии
...
Когда вы использовали это умение, вы не можете накладывать никаких заклинаний, кроме заговоров до конца своего следующего хода.`,
        'ТАКТИЧЕСКАЯ СМЕКАЛКА': `2-й уровень, умение военной магии
Ваша способность оценивать тактические ситуации позволяет вам действовать быстрее в бою. Вы можете получить бонус к броску инициативы равный вашему модификатору Интеллекта.`,
        'ВСПЛЕСК МОЩИ': `6-й уровень, умение военной магии
...
Если вы заканчиваете короткий отдых не имея запасённых всплесков мощи, вы получаете один в свой запас. Один раз за ход, когда вы наносите урон существу или предмету заклинанием волшебника, вы можете потратить один всплеск мощи чтобы нанести дополнительный урон цели силовым полем. Дополнительный урон равен половине вашего уровня волшебника.`,
        'СТОЙКАЯ МАГИЯ': `10-й уровень, умение военной магии
Магия, которую вы поддерживаете, позволяет вам более эффективно защищаться. Пока вы поддерживаете концентрацию на заклинании, вы получаете бонус +2 к КД и всем спасброскам.`,
        'ОТРАЖАЮЩИЙ ПОКРОВ': `14-й уровень, умение военной магии
...
При необходимости вы можете заменить книгу во время короткого отдыха, используя волшебное перо для рисования магической печати на пустой книге или магической книге заклинаний, на которую вы настроены. По окончании отдыха сознание вашей книги заклинаний призывается в новую книгу, после чего оно превращает новую книгу в вашу книгу заклинаний со всеми заклинаниями в ней. Если ваша старая книга заклинаний всё ещё существует, заклинания исчезают с её страниц.`,
        'Пробуждение разума': `6-й уровень, умение ордена писцов
...
После того, как вы пробуждаете разум, вы не можете сделать это вновь, пока не окончите продолжительный отдых или не потратите ячейку заклинаний любого уровня на повторное использование этого умения.`,
        'Мастер скриптория': `10-й уровень, умение ордена писцов
...
Вы очень искусны в создании свитков заклинаний, описанных в главе 7 «Руководства Мастера». Золото и время, необходимое на создание таких свитков заклинаний, снижается вдвое, если вы используете волшебное перо.`,
        'Единство со словом': `14-й уровень, умение ордена писцов
...
После того, как вы использовали реакцию таким образом, вы не сможете сделать это вновь, пока не закончите продолжительный отдых.`,
    ...
    'Песнь клинка': {
      ...
      descriptions: {
        'Тренировка войны и песни': `2-й уровень, умение песни клинка
...
Вы также получаете владение навыком Выступление, если вы им еще не владеете.`,
        'Песнь клинка': `2-й уровень, умение песни клинка
...
Вы можете использовать это умение количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Дополнительная атака': `6-й уровень, умение песни клинка
Если вы в свой ход совершаете действие Атака, вы можете совершить две атаки вместо одной. Кроме того, вы можете наложить один из своих заговоров вместо одной из этих атак.`,
        'Песнь защиты': `10-й уровень, умение песни клинка
Пока длится ваша «Песнь клинка», вы можете направить свою магию на поглощение урона. Когда вы получаете урон, вы можете реакцией потратить одну ячейку заклинаний и уменьшить получаемый вами урон на уровень потраченной ячейки, умноженный на пять.`,
        'Песнь победы': `14-й уровень, умение песни клинка
Пока длится ваша «Песнь клинка», вы добавляете модификатор Интеллекта (минимум +1) к урону от своих рукопашных атак оружием.`,
  ...
  'Друид': {
    'Круг земли': {
      ...
      descriptions: {
        'ДОПОЛНИТЕЛЬНЫЙ ЗАГОВОР': `2-й уровень, умение круга земли
Вы осваиваете один дополнительный заговор друида на свой выбор. Этот заговор не учитывается в общем количестве известных вам заговоров друида.`,
        'ЕСТЕСТВЕННОЕ ВОССТАНОВЛЕНИЕ': `2-й уровень, умение круга земли
...
Например, будучи друидом 4-го уровня, вы можете восстановить два уровня ячеек заклинаний. Вы можете восстановить или ячейку 2-го уровня или две ячейки 1-го уровня.`,
        'ЗАКЛИНАНИЯ КРУГА': `3-й уровень, умение круга земли
...
Получив доступ к заклинанию круга, вы будете всегда иметь его подготовленным, и оно не учитывается при подсчёте количества заклинаний, которые можно подготовить. Если вы получаете доступ к заклинанию, отсутствующему в списке заклинаний друида, оно всё равно будет считаться для вас заклинанием друида.`,
        'ТРОПАМИ ЗЕМЛИ': `6-й уровень, умение круга земли
...
9
наблюдение [scrying], нашествие насекомых [insect plague]
Гора
Уровень друида
Заклинания круга
3
паук [spider climb], шипы [spike growth]
5
молния [lightning bolt], слияние с камнем [meld into stone]
7
изменение формы камня [stone shape], каменная кожа [stoneskin]
9
каменная стена [wall of stone], создание прохода [passwall]
Лес
Уровень друида
Заклинания круга
3
дубовая кора [barkskin], паук [spider climb]
5
призыв молнии [call lightning], рост растений [plant growth]
7
предсказание [divination], свобода перемещения [freedom of movement]
9
древесный путь [tree stride], общение с природой [commune with nature]
Луг
Уровень друида
Заклинания круга
3
бесследное передвижение [pass without trace], невидимость [invisibility]
5
дневной свет [daylight], ускорение [haste]
7
предсказание [divination], свобода перемещения [freedom of movement]
9
вещий сон [dream], нашествие насекомых [insect plague]
Побережье
Уровень друида
Заклинания круга
3
отражения [mirror image], туманный шаг [misty step]
5
подводное дыхание [water breathing], хождение по воде [water walk]
7
власть над водами [control water], свобода перемещения [freedom of movement]
9
наблюдение [scrying], призыв элементаля [conjure elemental]
Подземье
Уровень друида
Заклинания круга
3
паук [spider climb], паутина [web]
5
газообразная форма [gaseous form], зловонное облако [stinking cloud]
7
высшая невидимость [greater invisibility], изменение формы камня [stone shape]
9
нашествие насекомых [insect plague], облако смерти [cloudkill]
Пустыня
Уровень друида
Заклинания круга
3
размытый образ [blur], тишина [silence]
5
защита от энергии [protection from energy], сотворение пищи и воды [create food and water]
7
мираж [hallucinatory terrain], усыхание [blight]
9
каменная стена [wall of stone], нашествие насекомых [insect plague]
Тундра
Уровень друида
Заклинания круга
3
удержание личности [hold person], шипы [spike growth]
5
замедление [slow], метель [sleet storm]
7
град [ice storm], свобода перемещения [freedom of movement]
9
конус холода [cone of cold], общение с природой [commune with nature]`,
      },
    },
    'Круг луны': {
      features: {
      ...
      descriptions: {
        'БОЕВОЙ ДИКИЙ ОБЛИК': `2-й уровень, умение круга луны
...
Кроме того, пока вы перевоплощены умением «Дикий облик», вы можете бонусным действием потратить ячейку заклинания, чтобы восстановить 1к8 хитов за каждый уровень потраченной ячейки.`,
        'ОБЛИКИ КРУГА': `2-й уровень, умение круга луны
...
Вы можете потратить сразу два использования «Дикого облика», чтобы принять облик водяного, воздушного, земляного или огненного элементаля.`,
        'ТЫСЯЧА ЛИЦ': `14-й уровень, умение круга луны
...
Дух ястреба. Дух ястреба — непревзойдённый охотник, помогающий вам и вашим союзникам своим острым взглядом. Когда существо совершает бросок атаки по цели, находящейся в ауре духа, вы можете реакцией дать преимущество на этот бросок. Кроме того, вы и ваши союзники совершаете с преимуществом проверки Мудрости (Восприятие), пока находитесь в ауре.`,
        'МОГУЩЕСТВЕННЫЙ ПРИЗЫВАТЕЛЬ': `6-й уровень, умение круга пастыря
...
Урон от природных оружий существа считается магическим при определении преодоления сопротивления и иммунитета к немагическим атакам и урону.`,
        'ДУХ ЗАЩИТНИК': `10-й уровень, умение круга пастыря
Ваш тотем духа защищает Зверей и Фей, которых вы вызываете своей магией. Когда Зверь или Фея, которых вы вызвали или создали заклинанием, заканчивает свой ход в ауре вашего тотема духа, это существо восстанавливает хиты в количестве, равном половине вашего уровня друида.`,
        'ВЕРНЫЕ ПРИЗВАННЫЕ': `14-й уровень, умение круга пастыря
...
Заклинание не требует концентрации и длится 1 час или пока вы не отмените его (отмена не тратит никаких действий). Использовав это умение, вы не можете использовать его повторно до окончания короткого или продолжительного отдыха.`,
    ...
    'Круг снов': {
      ...
      descriptions: {
        'УТЕШЕНИЕ ЛЕТНЕГО ДВОРА': `2-й уровень, умение круга снов
...
Вы восстанавливаете все потраченные кости после окончания продолжительного отдыха.`,
        'ОЧАГ ЛУННОГО СВЕТА И ТЕНИ': `6-й уровень, умение круга снов
...
Сфера исчезает в конце отдыха или когда вы покидаете сферу.`,
        'СКРЫТЫЕ ПУТИ': `10-й уровень, умение круга снов
...
Вы можете использовать эту способность количество раз, равное вашему модификатору Мудрости (минимум один раз). Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'СТРАННИК ВО СНАХ': `14-й уровень, умение круга снов
...
Использовав это умение, вы не можете использовать его повторно до окончания продолжительного отдыха.`,
    ...
    'Круг дикого огня': {
      features: {
        2: ["Заклинания круга", "Призыв духа дикого огня"],
        6: ["Усиленная связь"],
        10: ["Прижигающее пламя"],
        14: ["Огненное возрождение"],
      },
      descriptions: {
        'Заклинания круга': `2-й уровень, умение круга дикого огня
...
Заклинания
2
лечение ран [cure wounds], огненные ладони [burning hands]
3
палящий луч [scorching ray], пылающий шар [flaming sphere]
5
возрождение [revivify], рост растений [plant growth]
7
аура жизни [aura of life], огненный щит [fire shield]
9
множественное лечение ран [mass cure wounds], небесный огонь [flame strike]`,
        'Призыв духа дикого огня': `2-й уровень, умение круга дикого огня
...
Дух дикого огня исчезает по истечении 1 часа, либо когда его хиты уменьшаются до 0, либо когда вы используете «Дикий облик» подобным образом повторно, либо когда вы умираете.`,
        'Усиленная связь': `6-й уровень, умение круга дикого огня
...
Кроме того, когда вы накладываете заклинание с дистанцией, отличной от «на себя», центром накладывания этого заклинания можете выступать либо вы, либо дух дикого огня.`,
        'Прижигающее пламя': `10-й уровень, умение круга дикого огня
...
Вы можете использовать эту реакцию количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Огненное возрождение': `14-й уровень, умение круга дикого огня
...
Использовав это умение, вы не сможете применить его повторно, пока не закончите продолжительный отдых.`,
    ...
    'Круг звёзд': {
      ...
      descriptions: {
        'Звёздная карта': `2-й уровень, умение круга звёзд
...
3
Пятнистая шкура совомеда, украшенная рельефными метками
4
...
Стеклянные диски с изображением созвездий`,
        'Звёздный облик': `2-й уровень, умение круга звёзд
...
Дракон. На вас проявляется созвездие мудрого дракона. Когда вы совершаете проверку Интеллекта или Мудрости, а также когда вы совершаете спасбросок Телосложения для поддержания концентрации на заклинании, вы можете при выпадении на к20 результата «1–9» считать, что выпало «10».`,
        'Космическое знамение': `6-й уровень, умение круга звёзд
...
Вы можете использовать эту реакцию количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Мерцающие созвездия': `10-й уровень, умение круга звёзд
...
Кроме того, в начале каждого вашего хода, пока вы находитесь в своём звёздном облике, вы можете менять созвездия, мерцающие на вашем теле.`,
        'Состоящий из звёзд': `14-й уровень, умение круга звёзд
...
Когда вы совершаете бросок урона звуком или электричеством, вы можете использовать «Божественный канал», чтобы нанести максимальный урон вместо броска.`,
        'УДАР ГРОМА': `6-й уровень, умение домена бури
Когда вы наносите урон электричеством существу с размером Большое или меньше, вы также можете оттолкнуть его на 10 футов от себя.`,
        'БОЖЕСТВЕННЫЙ УДАР': `8-й уровень, умение домена бури
...
У вас появляется скорость полёта, равная вашей текущей наземной скорости ходьбы, когда вы не под землёй и не в помещении.`,
    ...
    'Домен войны': {
      ...
      descriptions: {
        'БОНУСНОЕ ВЛАДЕНИЕ': `1-й уровень, умение домена войны
Вы получаете владение воинским оружием и тяжёлыми доспехами.`,
        'БОЕВОЙ СВЯЩЕННИК': `1-й уровень, умение домена войны
Ваш бог наделяет вас воодушевлением, когда вы вступаете в битву. Когда вы используете действие Атака, вы можете совершить одну атаку оружием бонусным действием. Вы можете использовать это умение количество раз, равное вашему модификатору Мудрости (минимум 1 раз). Вы восстанавливаете все потраченные использования, когда завершаете продолжительный отдых.`,
        'БОЖЕСТВЕННЫЙ КАНАЛ: НАПРАВЛЕННЫЙ УДАР': `2-й уровень, умение домена войны
Вы можете использовать «Божественный канал», чтобы нанести удар со сверхъестественной точностью. Когда вы совершаете бросок атаки, вы можете использовать «Божественный канал», чтобы получить бонус +10 к броску. Вы можете решить, применять ли это умение, после того как увидите результат броска, но до того как Мастер скажет, попала атака или промахнулась.`,
        'БОЖЕСТВЕННЫЙ КАНАЛ: БЛАГОСЛОВЕНИЕ БОГА ВОЙНЫ': `6-й уровень, умение домена войны
Если существо в пределах 30 футов от вас совершает бросок атаки, вы можете реакцией предоставить этому существу бонус +10 к броску, использовав «Божественный канал». Вы можете решить, применять ли это умение, после того как увидели результат броска, но до того как Мастер скажет, попала атака или промахнулась.`,
        'БОЖЕСТВЕННЫЙ УДАР': `8-й уровень, умение домена войны
Вы получаете способность наполнять удары своего оружия божественной энергией. Один раз в каждый свой ход, когда вы попадаете по существу атакой оружием, вы можете причинить цели дополнительный урон 1к8 того же вида, что и у оружия. Когда вы достигаете 14 уровня, дополнительный урон увеличивается до 2к8.`,
        'ВОПЛОЩЕНИЕ БИТВЫ': `17-й уровень, умение домена войны
Вы получаете сопротивление дробящему, колющему и рубящему урону от немагических атак.`,
      },
    },
    'Домен жизни': {
      features: {
        1: ["БОНУСНОЕ ВЛАДЕНИЕ", "ПОБОРНИК ЖИЗНИ"],
      ...
      descriptions: {
        'БОНУСНОЕ ВЛАДЕНИЕ': `1-й уровень, умение домена жизни
Вы получаете владение тяжёлыми доспехами.`,
        'ПОБОРНИК ЖИЗНИ': `1-й уровень, умение домена жизни
Ваши лечащие заклинания становятся более эффективными. Каждый раз, когда вы используете заклинание? 1-го уровня или выше, восстанавливающее хиты существу, это существо восстанавливает дополнительно число хитов, равное 2 + уровень заклинания.`,
        'БОЖЕСТВЕННЫЙ КАНАЛ: СОХРАНЕНИЕ ЖИЗНИ': `2-й уровень, умение домена жизни
Вы можете использовать «Божественный канал», чтобы лечить тяжёлые ранения. Вы действием демонстрируете свой священный символ и призываете целительную энергию, которая может восстановить число хитов, равное вашему уровню жреца, умноженному на пять. Выберите любых существ в пределах 30 футов от себя и распределите эти хиты между ними. Это умение не может восстановить существу хиты выше половины от его максимума. Вы не можете использовать это умение на Нежити и Конструктах.`,
        'БЛАГОСЛОВЕННЫЙ ЦЕЛИТЕЛЬ': `6-й уровень, умение домена жизни
Заклинания лечения, которое вы накладываете на других, также лечат и вас. Когда вы накладываете заклинание 1-го уровня или выше, которое восстанавливает хиты другому существу, вы восстанавливаете себе число хитов, равное 2 + уровень заклинания.`,
        'БОЖЕСТВЕННЫЙ УДАР': `8-й уровень, умение домена жизни
Вы получаете способность наполнять удары своего оружия божественной энергией. Один раз в каждый свой ход, когда вы попадаете по существу атакой оружием, вы можете причинить цели дополнительный урон излучением 1к8. Когда вы достигаете 14-го уровня, дополнительный урон возрастает до 2к8.`,
        'ВЫСШЕЕ ИСЦЕЛЕНИЕ': `17-й уровень, умение домена жизни
Если вы должны бросить одну или несколько костей, чтобы восстановить заклинанием хиты, вы для каждой кости используете максимальное значение. Например, вместо восстановления существу 2к6 хитов, вы восстанавливаете 12.`,
    ...
    'Домен знаний': {
      features: {
        1: ["БЛАГОСЛОВЕНИЕ ЗНАНИЙ"],
        2: ["БОЖЕСТВЕННЫЙ КАНАЛ: ЗНАНИЯ ВЕКОВ"],
        6: ["БОЖЕСТВЕННЫЙ КАНАЛ: ЧТЕНИЕ МЫСЛЕЙ"],
        8: ["МОГУЩЕСТВЕННОЕ КОЛДОВСТВО"],
        17: ["ВИДЕНИЯ ПРОШЛОГО"],
      },
      descriptions: {
        'БЛАГОСЛОВЕНИЕ ЗНАНИЙ': `1-й уровень, умение домена знаний
...
Ваш бонус мастерства удваивается для всех проверок характеристик при использовании выбранных навыков.`,
        'БОЖЕСТВЕННЫЙ КАНАЛ: ЗНАНИЯ ВЕКОВ': `2-й уровень, умение домена знаний
Вы можете использовать «Божественный канал», чтобы получить доступ к источнику знаний. Вы действием выбираете навык или инструмент. На 10 минут вы осваиваете владение выбранным навыком или инструментом.`,
        'БОЖЕСТВЕННЫЙ КАНАЛ: ЧТЕНИЕ МЫСЛЕЙ': `6-й уровень, умение домена знаний
...
В течение этого времени вы можете действием окончить этот эффект, накладывая на существо заклинание внушение [suggestion], не тратя ячейку заклинания. Цель автоматически проваливает спасбросок от этого заклинания.`,
        'МОГУЩЕСТВЕННОЕ КОЛДОВСТВО': `8-й уровень, умение домена знаний
Вы добавляете модификатор Мудрости к урону, который причиняете заговорами жреца.`,
        'ВИДЕНИЯ ПРОШЛОГО': `17-й уровень, умение домена знаний
...
Чтение окрестностей. Пока вы медитируете, вы наблюдаете видения последних событий, произошедших в непосредственной близости (комната, улица, туннель, поляна и тому подобное в пределах куба с длиной ребра 50 футов), на протяжении количества прошедших дней, равного значению вашей Мудрости. За каждую минуту медитации вы узнаёте об одном значимом событии, начиная с самого последнего. Значимые события обычно связаны с сильными эмоциями, например, битвами и предательствами, свадьбами и убийствами, родами и похоронами. Однако они могут также включать в себя более обыденные события, которые, тем не менее, важны в текущей ситуации.`,
    ...
    'Домен обмана': {
      ...
      descriptions: {
        'БЛАГОСЛОВЕНИЕ ОБМАНЩИКА': `1-й уровень, умение домена обмана
Вы можете действием коснуться согласного существа, отличного от вас, чтобы позволить ему совершать с преимуществом проверки Ловкости (Скрытность). Это благословение длится 1 час, или пока вы не используете это умение снова.`,
        'БОЖЕСТВЕННЫЙ КАНАЛ: ДВУЛИЧНОСТЬ': `2-й уровень, умение домена обмана
...
Вы действием создаёте идеальную иллюзию себя, которая существует в течение 1 минуты, или пока вы не потеряете концентрацию (как если бы вы концентрировались на заклинании). Иллюзия появляется в свободном пространстве, которое вы можете видеть в пределах 30 футов от себя. Бонусным действием в свой ход вы можете переместить иллюзию на расстояние до 30 футов в пространство, которое вы можете видеть, но иллюзия должна оставаться в пределах 120 футов от вас. На протяжении действия умения вы можете накладывать заклинания, как если бы вы находились в пространстве иллюзии, но вы должны использовать собственные чувства. Кроме того, когда и вы и ваша иллюзия находитесь в пределах 5 футов от существа, которое может видеть иллюзию, вы совершаете броски атаки по этому существу с преимуществом, так как иллюзия отвлекает его.`,
        'БОЖЕСТВЕННЫЙ КАНАЛ: ПЛАЩ ТЕНЕЙ': `6-й уровень, умение домена обмана
Вы можете использовать «Божественный канал», чтобы исчезать. Вы действием становитесь невидимым до конца своего следующего хода. Вы становитесь видимым, если атакуете или накладываете заклинание.`,
        'БОЖЕСТВЕННЫЙ УДАР': `8-й уровень, умение домена обмана
Вы получаете способность наполнять удары своего оружия ядом — это дар вашего божества. Один раз в каждый свой ход, когда вы попадаете по существу атакой оружием, вы можете причинить цели дополнительный урон ядом 1к8. Когда вы достигаете 14-го уровня, дополнительный урон возрастает до 2к8.`,
        'УЛУЧШЕННАЯ ДВУЛИЧНОСТЬ': `17-й уровень, умение домена обмана
Вы можете создать до четырёх копий себя, вместо одной, когда вы используете «Двуличность». Бонусным действием в свой ход вы можете переместить любое количество копий на 30 футов, максимальная дистанция от вас не должна превышать 120 футов.`,
    ...
    'Домен природы': {
      features: {
        1: ["ПОСЛУШНИК ПРИРОДЫ", "БОНУСНОЕ ВЛАДЕНИЕ"],
      ...
      descriptions: {
        'ПОСЛУШНИК ПРИРОДЫ': `1-й уровень, умение домена природы
Вы изучаете один заговор друида на свой выбор. Этот заговор считается заговором жреца для вас, но он не учитывается в общем количестве известных вам заговоров жреца. Вы также получаете владение одним из следующих навыков: Выживание, Природа, Уход за животными.`,
        'БОНУСНОЕ ВЛАДЕНИЕ': `1-й уровень, умение домена природы
Вы получаете владение тяжёлыми доспехами.`,
...
Вы действием демонстрируете свой священный символ и называете имя своего божества. Все Звери и Растения, которые могут видеть вас, и находятся в пределах 30 футов от вас, должны совершить спасбросок Мудрости. Если существо провалит спасбросок, оно становится очарованным вами на 1 минуту, или пока не получит урон. Пока существо очаровано, оно дружелюбно к вам и другим существам, которых вы укажете.`,
        'СДЕРЖИВАНИЕ СТИХИЙ': `6-й уровень, умение домена природы
Когда вы или существо в пределах 30 футов от вас получает урон звуком, кислотой, огнём, холодом или электричеством, вы можете реакцией предоставить существу сопротивление этому урону.`,
        'БОЖЕСТВЕННЫЙ УДАР': `8-й уровень, умение домена природы
Вы получаете способность наполнять удары своего оружия божественной энергией. Один раз в каждый свой ход, когда вы попадаете по существу атакой оружием, вы можете причинить цели дополнительный урон огнём, холодом или электричеством (на ваш выбор) 1к8. Когда вы достигаете 14-го уровня, дополнительный урон возрастает до 2к8.`,
        'МАСТЕР ПРИРОДЫ': `17-й уровень, умение домена природы
Вы получаете способность командовать животными и растительными существами. Пока существа очарованы вашим умением «Очарование животных и растений», вы можете бонусным действием в свой ход устно указать, что каждое из них будет делать в свой следующий ход.`,
    ...
    'Домен света': {
      features: {
        1: ["ДОПОЛНИТЕЛЬНЫЙ ЗАГОВОР", "ЗАЩИЩАЮЩАЯ ВСПЫШКА"],
      ...
      descriptions: {
        'ДОПОЛНИТЕЛЬНЫЙ ЗАГОВОР': `1-й уровень, умение домена света
Вы изучаете заговор свет [light], если еще не имели его раньше. Этот заговор не учитывается в количестве известных вам заговоров жреца.`,
        'ЗАЩИЩАЮЩАЯ ВСПЫШКА': `1-й уровень, умение домена света
Вы можете создать божественный свет между собой и атакующим противником. Если вас атакует существо, которое вы видите в пределах 30 футов, вы можете реакцией создать помеху его броску атаки, вызывая перед атакующим вспышку света, до того как он попадёт или промажет. Существа, которые не могут быть ослеплены, обладают иммунитетом к этому умению. Вы можете использовать это умение количество раз, равное вашему модификатору Мудрости (минимум один раз). Вы восстанавливаете все потраченные использования, когда завершаете продолжительный отдых.`,
        'БОЖЕСТВЕННЫЙ КАНАЛ: СИЯНИЕ РАССВЕТА': `2-й уровень, умение домена света
...
Вы действием демонстрируете свой священный символ, и вся магическая тьма в пределах 30 футов от вас рассеивается. Кроме того, все враждебные существа в пределах 30 футов от вас должны совершить спасбросок Телосложения. Существа получают урон излучением, равный 2к10 + ваш уровень жреца в случае провала, и половину этого урона в случае успешного спасброска. Существа с полным укрытием от вас не подвержены воздействию.`,
        'УЛУЧШЕННАЯ ВСПЫШКА': `6-й уровень, умение домена света
Вы можете использовать умение «Защищающая вспышка», когда существо, которое вы можете видеть в пределах 30 футов от себя, атакует не вас, а другое существо.`,
        'МОГУЩЕСТВЕННОЕ КОЛДОВСТВО': `8-й уровень, умение домена света
Вы добавляете модификатор Мудрости к урону, который причиняете заговорами жреца.`,
        'КОРОНА СВЕТА': `17-й уровень, умение домена света
Вы можете действием создать ауру солнечного света, которая существует 1 минуту или пока вы не рассеете её еще одним действием. Вы испускаете яркий свет в радиусе 60 футов и тусклый свет в радиусе еще 30 футов. Ваши противники, находящиеся на ярком свету, совершают с помехой спасброски от любых заклинаний, причиняющих урон огнём или излучением.`,
    ...
    'Домен кузни': {
      features: {
        1: ["БОНУСНОЕ ВЛАДЕНИЕ", "БЛАГОСЛОВЛЕНИЕ КУЗНИЦЫ"],
        2: ["БОЖЕСТВЕННЫЙ КАНАЛ: БЛАГОСЛОВЕНИЕ РЕМЕСЛЕННИКА"],
        6: ["ДУША КУЗНИЦЫ"],
        8: ["БОЖЕСТВЕННЫЙ УДАР"],
        17: ["СВЯТОЙ КУЗНИЦЫ И ОГНЯ"],
      },
      descriptions: {
        'БОНУСНОЕ ВЛАДЕНИЕ': `1-й уровень, умение домена кузни
...
Использовав это умение, вы не можете использовать его повторно до окончания продолжительного отдыха.`,
        'БОЖЕСТВЕННЫЙ КАНАЛ: БЛАГОСЛОВЕНИЕ РЕМЕСЛЕННИКА': `2-й уровень, умение домена кузни
...
Ритуал может создать дубликат немагического предмета, который содержит металл, такой как ключ, если вы обладаете оригиналом во время ритуала.`,
        'ДУША КУЗНИЦЫ': `6-й уровень, умение домена кузни
...
Когда вы носите тяжёлый доспех, то получаете +1 к КД`,
        'БОЖЕСТВЕННЫЙ УДАР': `8-й уровень, умение домена кузни
...
Когда вы достигаете 14-го уровня, дополнительный урон увеличивается до 2к8.`,
        'СВЯТОЙ КУЗНИЦЫ И ОГНЯ': `17-й уровень, умение домена кузни
...
Когда вы носите тяжёлые доспехи, вы получаете сопротивление дробящему, колющему и рубящему урону от немагических атак.`,
    ...
    'Домен упокоения': {
      ...
      descriptions: {
        'КРУГ СМЕРТИ': `1-й уровень, умение домена упокоения
...
Кроме того, вы изучаете заговор уход за умирающим [spare the dying], который не учитывается при подсчёте известных вам заговоров жреца. Для вас он имеет дистанцию 30 футов, и вы можете накладывать его бонусным действием.`,
        'ГЛАЗА МОГИЛЫ': `1-й уровень, умение домена упокоения
...
Действием вы выбираете одно существо, которое вы можете видеть, в пределах 30 футов от вас, проклиная его до конца вашего следующего хода. Когда вы или союзник попадете по проклятому существу атакой, у существа будет уязвимость ко всему урону от атаки, а затем проклятие заканчивается.`,
        'СТРАЖ НА ПОРОГЕ СМЕРТИ': `6-й уровень, умение домена упокоения
...
Вы восстанавливаете все потраченные применения, после окончания продолжительного отдыха.`,
        'МОГУЩЕСТВЕННОЕ КОЛДОВСТВО': `8-й уровень, умение домена упокоения
Вы добавляете модификатор Мудрости к урону, который вы наносите любым заговором жреца.`,
        'ХРАНИТЕЛЬ ДУШ': `17-й уровень, умение домена упокоения
...
Вы можете использовать эту способность, только если вы не являетесь недееспособным. Использовав это умение, вы не можете использовать его повторно до начала вашего следующего хода.`,
    ...
    'Домен мира': {
      features: {
        1: ["Заклинания домена", "Установление мира", "Ободряющая связь"],
        2: ["Божественный канал: Бальзам мира"],
        6: ["Защитная связь"],
        8: ["Могущественное колдовство"],
        17: ["Расширенная связь"],
      },
      descriptions: {
        'Заклинания домена': `1-й уровень, умение домена мира
Вы получаете заклинания домена согласно таблице «Заклинания домена мира».
Заклинания домена мира
Уровень жреца
Заклинания
1
героизм [heroism], убежище [sanctuary]
3
охраняющая связь [warding bond], подмога [aid]
5
маяк надежды [beacon of hope], послание [sending]
7
аура очищения [aura of purity], Отилюков упругий шар [Оtiluke’s resilient sphere]
9
высшее восстановление [greater restoration], ментальная связь Рэри [Rary’s telepathic bond]`,
        'Установление мира': `1-й уровень, умение домена мира
Вы получаете владение навыком Проницательность, Выступление или Убеждение (по вашему выбору).`,
        'Ободряющая связь': `1-й уровень, умение домена мира
...
Вы можете использовать свой «Божественный канал», чтобы сделать само своё присутствие умиротворяющим бальзамом. Действием вы можете передвинуться на любое расстояние вплоть до своей скорости, не провоцируя атак. Когда вы оказываетесь в пределах 5 футов от любого другого существа во время этого действия, вы можете восстановить существу количество хитов, равное 2к6 + ваш модификатор Мудрости (минимум 1 хит). Существо может получить это исцеление только один раз, пока вы совершаете это действие.`,
        'Защитная связь': `6-й уровень, умение домена мира
Связь, которую вы устанавливаете между личностями, помогает им защищать друг друга. Когда существо, связанное вашим умением «Ободряющая связь», должно получить урон, другое связанное с ним существо, находящееся в пределах 30 футов от него, может реакцией телепортироваться в свободное пространство в пределах 5 футов от первого существа, после чего оно получает весь урон, который был предназначен первому существу.`,
        'Могущественное колдовство': `8-й уровень, умение домена мира
Вы добавляете свой модификатор Мудрости к урону, который наносите любыми заговорами жреца.`,
        'Расширенная связь': `17-й уровень, умение домена мира
Преимущества ваших умений «Ободряющая связь» и «Защитная связь» теперь действуют, когда существа находятся в пределах 60 футов друг от друга. Более того, когда существо использует «Защитную связь», оно получает сопротивление урону, получаемому в результате этого умения.`,
    ...
    'Домен сумерек': {
      features: {
        1: ["Заклинания домена", "БОНУСНОЕ ВЛАДЕНИЕ", "Глаза ночи", "Благословение бдительности"],
        2: ["Божественный канал: Сумеречное святилище"],
        6: ["Шаги ночи"],
        8: ["Божественный удар"],
        17: ["Сумеречная пелена"],
      },
      descriptions: {
        'Заклинания домена': `1-й уровень, умение домена сумерек
...
3
видение невидимого [see invisibility], лунный луч [moonbeam]
5
аура живучести [aura of vitality], Леомундова хижина [Leomund’s tiny hut]
7
аура жизни [aura of life], высшая невидимость [greater invisibility]
9
круг силы [circle of power], фальшивый двойник [mislead]`,
        'БОНУСНОЕ ВЛАДЕНИЕ': `1-й уровень, умение домена сумерек
Вы получаете владение воинским оружием и тяжёлыми доспехами.`,
...
Ночь научила вас бдительности. Действием вы касаетесь одного существа (включая себя) и даруете ему преимущество на совершение следующего броска инициативы. Это преимущество пропадает сразу после совершения броска или при повторном использовании этого умения.`,
        'Божественный канал: Сумеречное святилище': `2-й уровень, умение домена сумерек
...
Окончить одно действие эффекта очарования или испуга.`,
        'Шаги ночи': `6-й уровень, умение домена сумерек
...
Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Божественный удар': `8-й уровень, умение домена сумерек
Вы получаете способность наделять удары своего оружия божественной энергией. Один раз в каждый свой ход, когда вы попадаете по существу атакой оружием, вы можете нанести цели дополнительно 1к8 урона излучением. Когда вы достигаете 14-го уровня, этот урон увеличивается до 2к8.`,
        'Сумеречная пелена': `17-й уровень, умение домена сумерек
Вы призываете сумрак, окутывающий вас защищающим объятьем: вы и ваши союзники, находящиеся в сфере, созданной вашим сумеречным святилищем, получаете укрытие на половину.`,
  ...
  'Искусник': {
    'Алхимик': {
      features: {
        3: ["ВЛАДЕНИЕ ИНСТРУМЕНТАМИ", "ЗАКЛИНАНИЯ АЛХИМИКОВ", "ЭКСПЕРИМЕНТАЛЬНЫЙ ЭЛИКСИР"],
        5: ["УЧЁНЫЙ АЛХИМИК"],
        9: ["ВОССТАНАВЛИВАЮЩИЕ РЕАГЕНТЫ"],
        15: ["ХИМИЧЕСКОЕ МАСТЕРСТВО"],
      },
      descriptions: {
        'ВЛАДЕНИЕ ИНСТРУМЕНТАМИ': `3-й уровень, умение алхимика
...
инструментами ремесленника по вашему выбору.`,
        'ЗАКЛИНАНИЯ АЛХИМИКОВ': `3-й уровень, умение алхимика
...
оживление [raise dead]`,
        'ЭКСПЕРИМЕНТАЛЬНЫЙ ЭЛИКСИР': `3-й уровень, умение алхимика
...
смена обличья [alter self]. Выпивающий определяет трансформацию, вызываемую заклинанием, и этот эффект длится 10 минут.`,
        'УЧЁНЫЙ АЛХИМИК': `5-й уровень, умение алхимика
Вы достигли мастерства в использовании магических реагентов и научились усиливать исцеление и урон, наносимые с их помощью. Каждый раз, когда вы накладываете заклинание, используя инструменты алхимика в качестве фокусировки, вы получаете бонус к одному из бросков этого заклинания. Этот бросок должен восстанавливать хиты или наносить урон кислотой, огнём, некротической энергией или ядом. Бонус равен вашему модификатору Интеллекта (минимум +1).`,
        'ВОССТАНАВЛИВАЮЩИЕ РЕАГЕНТЫ': `9-й уровень, умение алхимика
...
малое восстановление [lesser restoration] без использования ячейки заклинаний и без подготовки заклинания при условии, что вы используете инструменты алхимика в качестве заклинательной фокусировки. Вы можете использовать это умение количество раз, равное вашему модификатору Интеллекта (минимум один раз), и вы восстанавливаете все потраченные использования, когда завершаете продолжительный отдых.`,
        'ХИМИЧЕСКОЕ МАСТЕРСТВО': `15-й уровень, умение алхимика
...
полное исцеление [heal] без использования ячейки заклинаний, подготовки и использования материальных компонентов при условии, что вы используете инструменты алхимика в качестве заклинательной фокусировки. Как только вы накладываете одно из этих заклинаний с помощью данного умения, вы не можете наложить его повторно, пока не закончите продолжительный отдых.`,
    ...
    'Артиллерист': {
      features: {
        3: ["Владение инструментами", "ЗАКЛИНАНИЯ АРТИЛЛЕРИСТА", "МИСТИЧЕСКАЯ ПУШКА"],
...
5
дребезги [shatter], палящий луч [scorching ray]
9
...
Пушка испускает вспышку положительной энергии, которая даёт каждому существу по вашему выбору в пределах 10 футов от пушки и самой пушке количество временных хитов, равное 1к8 + ваш модификатор Интеллекта (минимум +1).`,
        'Мистическое ОГНЕСТРЕЛЬНОЕ ОРУЖИЕ': `5-й уровень, умение артиллериста
...
Вы можете использовать своё мистическое огнестрельное оружие как заклинательную фокусировку для ваших заклинаний изобретателя. Когда вы накладываете заклинание изобретателя с помощью огнестрельного оружия, бросьте к8 и добавьте результат этого броска к одному из бросков урона заклинания.`,
        'ВЗРЫВООПАСНАЯ ПУШКА': `9-й уровень, умение артиллериста
...
Если вы находитесь в пределах 60 футов от пушки, то можете действием приказать ей взорваться. Это уничтожает пушку и заставляет каждое существо в пределах 20 футов от неё совершить спасбросок Ловкости против Сл спасброска ваших заклинаний, получая 3к8 урона силовым полем при провале и половину этого урона при успехе.`,
        'УКРЕПЛЁННАЯ ПОЗИЦИЯ': `15-й уровень, умение артиллериста
...
Теперь у вас может быть две пушки одновременно. Вы можете создавать две пушки одним действием (но не за одну ячейку заклинаний), и активировать их одновременно бонусным действием. Вы определяете, одинаковы ли эти пушки или отличаются друг от друга. Вы не можете создать третью пушку, пока у вас есть две.`,
    ...
    'Боевой кузнец': {
      features: {
        3: ["ВЛАДЕНИЕ ИНСТРУМЕНТАМИ", "ЗАКЛИНАНИЯ БОЕВОГО КУЗНЕЦА", "БОЕВАЯ ГОТОВНОСТЬ", "СТАЛЬНОЙ ЗАЩИТНИК"],
...
множественное лечение ран [mass cure wounds]`,
        'БОЕВАЯ ГОТОВНОСТЬ': `3-й уровень, умение боевого кузнеца
...
Когда вы совершаете в свой ход действие Атака, то можете совершить две атаки вместо одной.`,
        'МАГИЧЕСКАЯ ВСТРЯСКА': `9-й уровень, умение боевого кузнеца
...
Вы можете направлять эту магическую энергию количество раз, равное вашему модификатору Интеллекта (минимум один раз), но не более одного раза за ход. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'УЛУЧШЕННЫЙ ЗАЩИТНИК': `15-й уровень, умение боевого кузнеца
...
«Отражение атаки», атакующий получает урон силовым полем, равный 1к4 + ваш модификатор Интеллекта.`,
    ...
    'Бронник': {
      features: {
        3: ["ВЛАДЕНИЕ ИНСТРУМЕНТАМИ", "ЗАКЛИНАНИЯ БРОННИКА", "мистический ДОСПЕХ", "МОДЕЛЬ ДОСПЕХА"],
        5: ["ДОПОЛНИТЕЛЬНАЯ АТАКА"],
        9: ["МОДИФИКАЦИИ ДОСПЕХА"],
        15: ["ИДЕАЛЬНАЯ БРОНЯ"],
      },
      descriptions: {
        'ВЛАДЕНИЕ ИНСТРУМЕНТАМИ': `3-й уровень, умение бронника
...
инструментами ремесленника по вашему выбору.`,
        'ЗАКЛИНАНИЯ БРОННИКА': `3-й уровень, умение бронника
...
силовая стена [wall of force]`,
        'мистический ДОСПЕХ': `3-й уровень, умение бронника
...
Броня остаётся мистическим доспехом, пока вы не облачитесь в другой комплект доспехов или не умрёте.`,
        'МОДЕЛЬ ДОСПЕХА': `3-й уровень, умение бронника
...
Заглушающее поле. Вы совершаете с преимуществом проверки Ловкости (Скрытность). Если доспех накладывает помеху на данную проверку, то преимущество и помеха отменяют друг друга, как и обычно.`,
        'ДОПОЛНИТЕЛЬНАЯ АТАКА': `5-й уровень, умение бронника
Когда вы совершаете в свой ход действие Атака, то можете совершить две атаки вместо одной.`,
        'МОДИФИКАЦИИ ДОСПЕХА': `9-й уровень, умение бронника
Вы узнаёте, как использовать инфузии, чтобы особым образом модифицировать свой мистический доспех. Теперь для вашего умения «Инфузирование предмета» каждый элемент доспеха считается отдельным предметом: доспех (нагрудник), ботинки, шлем и специальное оружие доспеха. Любой из этих предметов может быть насыщен одной из ваших инфузий, которые остаются, даже если вы меняете модель доспеха с помощью соответствующего умения. Кроме того, ваше максимальное количество насыщенных магией предметов увеличивается на два при условии, что они являются частями вашего мистического доспеха.`,
        'ИДЕАЛЬНАЯ БРОНЯ': `15-й уровень, умение бронника
...
Лазутчик. Любое существо, получившее урон от «Метателя молний», начинает мерцать магическим светом до начала вашего следующего хода. Существо излучает тусклый свет в радиусе 5 футов и совершает броски атаки против вас с помехой, так как свет слепит его при попытке атаковать. Кроме того, следующая атака по этому существу совершается с преимуществом, и, если атака попадает, то цель дополнительно получает 1к6 урона электричеством.`,
  ...
  'Колдун': {
    'Архифея': {
      features: {
        1: ["РАСШИРЕННЫЙ СПИСОК ЗАКЛИНАНИЙ", "Фейское присутствие"],
        6: ["ТУМАННОЕ ИСЧЕЗНОВЕНИЕ"],
        10: ["ЧАРУЮЩАЯ ЗАЩИТА"],
        14: ["ТЁМНОЕ ИССТУПЛЕНИЕ"],
      },
      descriptions: {
        'РАСШИРЕННЫЙ СПИСОК ЗАКЛИНАНИЙ': `1-й уровень, умение архифеи
...
огонь фей [faerie fire], усыпление [sleep]
2
воображаемая сила [phantasmal force], умиротворение [calm emotions]
3
мерцание [blink], рост растений [plant growth]
4
высшая невидимость [greater invisibility], подчинение зверя [dominate beast]
5
подчинение личности [dominate person], притворство [seeming]`,
        'Фейское присутствие': `1-й уровень, умение архифеи
...
Использовав это умение, вы не можете использовать его снова, не завершив короткого либо продолжительного отдыха.`,
        'ТУМАННОЕ ИСЧЕЗНОВЕНИЕ': `6-й уровень, умение архифеи
Получив урон, вы можете раствориться облачком тумана. Если вы получили урон, вы можете реакцией стать невидимым и телепортироваться на расстоянии до 60 футов в видимое вами свободное пространство. Вы остаётесь невидимым до начала своего следующего хода, или пока не используете атаку или заклинание. Использовав это умение, вы не можете использовать его снова, не завершив короткого либо продолжительного отдыха.`,
        'ЧАРУЮЩАЯ ЗАЩИТА': `10-й уровень, умение архифеи
Ваш покровитель обучает вас, как обращать воздействующую на разум магию ваших врагов против них самих. Вы получаете иммунитет к состоянию очарованности, и если другое существо пытается очаровать вас, вы можете реакцией попытаться повернуть очарование против его создателя. Это существо должно преуспеть в спасброске Мудрости Сл ваших заклинаний колдуна, иначе оно станет очаровано вами на 1 минуту, или пока не получит любой урон.`,
        'ТЁМНОЕ ИССТУПЛЕНИЕ': `14-й уровень, умение архифеи
...
Использовав это умение, вы не можете использовать его снова, не завершив короткого либо продолжительного отдыха.`,
    ...
    'Исчадие': {
      features: {
        1: ["РАСШИРЕННЫЙ СПИСОК ЗАКЛИНАНИЙ", "БЛАГОСЛОВЕНИЕ ТЕМНЕЙШЕГО"],
        6: ["УДАЧА ТЕМНЕЙШЕГО"],
        10: ["УСТОЙЧИВОСТЬ ИСЧАДИЯ"],
        14: ["БРОСОК СКВОЗЬ АД"],
      },
      descriptions: {
        'РАСШИРЕННЫЙ СПИСОК ЗАКЛИНАНИЙ': `1-й уровень, умение исчадия
...
2
глухота/слепота [blindness/deafness], палящий луч [scorching ray]
3
зловонное облако [stinking cloud], огненный шар [fireball]
4
огненная стена [wall of fire], огненный щит [fire shield]
5
небесный огонь [flame strike], святилище [hallow]`,
        'БЛАГОСЛОВЕНИЕ ТЕМНЕЙШЕГО': `1-й уровень, умение исчадия
Когда вы опускаете хиты враждебного существа до 0, вы получаете временные хиты, равные вашему модификатору Харизмы + ваш уровень колдуна (минимум 1).`,
        'УДАЧА ТЕМНЕЙШЕГО': `6-й уровень, умение исчадия
...
Использовав это умение, вы не можете использовать его снова до окончания короткого или продолжительного отдыха.`,
        'УСТОЙЧИВОСТЬ ИСЧАДИЯ': `10-й уровень, умение исчадия
Вы можете выбрать один вид урона, когда заканчиваете короткий или продолжительный отдых. Вы получаете сопротивление этому виду урона, пока вы не выберете другой вид урона при помощи этого умения. Урон от магического или серебряного оружия игнорирует это сопротивление.`,
        'БРОСОК СКВОЗЬ АД': `14-й уровень, умение исчадия
...
Использовав это умение, вы не можете использовать его снова до окончания продолжительного отдыха.`,
    ...
    'Великий Древний': {
      features: {
        1: ["РАСШИРЕННЫЙ СПИСОК ЗАКЛИНАНИЙ", "ПРОБУЖДЁННЫЙ РАЗУМ"],
        6: ["ЭНТРОПИЧЕСКАЯ ОПЕКА"],
        10: ["МЕНТАЛЬНЫЙ ЩИТ"],
        14: ["СОЗДАТЬ РАБА"],
      },
      descriptions: {
        'РАСШИРЕННЫЙ СПИСОК ЗАКЛИНАНИЙ': `1-й уровень, умение великого древнего
...
2
воображаемая сила [phantasmal force], обнаружение мыслей [detect thoughts]
3
подсматривание [clairvoyance], послание [sending]
4
подчинение зверя [dominate beast], Эвардовы чёрные щупальца [Еvard’s black tentackles]
5
подчинение личности [dominate person], телекинез [telekinesis]`,
        'ПРОБУЖДЁННЫЙ РАЗУМ': `1-й уровень, умение великого древнего
Ваше чуждое знание даёт вам возможность касаться разума других существ. Вы можете общаться телепатически с любым существом, которое видите в пределах 30 футов от себя. Вам не нужно знать общий с существом язык для того, чтобы оно понимало ваши телепатические высказывания, но существо должно быть в состоянии понимать как минимум один язык.`,
        'ЭНТРОПИЧЕСКАЯ ОПЕКА': `6-й уровень, умение великого древнего
Вы научитесь магически опекать себя от атак и использовать неудачную вражескую атаку на пользу себе. Если существо совершает бросок атаки по вам, вы можете реакцией создать помеху для этого броска. Если атака промахнётся по вам, ваш следующий бросок атаки по этому существу совершается с преимуществом, если вы совершите его до конца своего следующего хода. Использовав это умение, вы не можете использовать его снова до окончания короткого или продолжительного отдыха.`,
        'МЕНТАЛЬНЫЙ ЩИТ': `10-й уровень, умение великого древнего
Ваши мысли не могут быть прочитаны телепатически или иными средствами, если вы не пожелаете обратного. Вы также получаете сопротивление урону психической энергией, и каждый раз, когда существо причиняет вам урон психической энергией, это существо получает такое же количество урона, что и вы.`,
        'СОЗДАТЬ РАБА': `14-й уровень, умение великого древнего
...
Заклинания
1-й
щит [shield], гневная кара [wrathful smite]
2-й
размытый образ [blur], клеймящая кара [branding smite]
3-й
мерцание [blink], стихийное оружие [elemental weapon]
4-й
воображаемый убийца [phantasmal killer], оглушающая кара [staggering smite]
5-й
изгоняющая кара [banishing smite], конус холода [cone of cold]`,
...
Когда вы атакуете этим оружием, вы можете использовать для бросков атаки и урона свой модификатор Харизмы вместо модификатора Силы или Ловкости. Это умение действует до тех пор, пока вы не закончите продолжительный отдых. Если вы позже заключаете Договор клинка, это умение распространяется на любое оружие договора, которое вы вызываете этим умением, независимо от типа оружия.`,
        'ПРОКЛЯТЫЙ СПЕКТР': `6-й уровень, умение ведьмовского клинка
...
Спектр [specter] продолжает служить вам до конца вашего следующего продолжительного отдыха, после чего он уходит в загробную жизнь. После сковывания спектра [specter] этим умением, вы не можете использовать его повторно до окончания продолжительного отдыха.`,
        'ПРОКЛЯТЫЙ ДОСПЕХ': `10-й уровень, умение ведьмовского клинка
Ваше проклятие становится более мощным. Если цель, проклятая вашим проклятием ведьмовского клинка, попадает по вам броском атаки, вы можете реакцией бросить к6. При результате 4 или выше атака промахивается по вам, независимо от броска проклятого существа.`,
        'МАСТЕР ПРОКЛЯТИЙ': `14-й уровень, умение ведьмовского клинка
Вы можете перенести «Проклятие ведьмовского клинка» с убитого существа на другое существо. Когда существо, проклятое «Проклятием ведьмовского клинка», умирает, вы можете переместить проклятие на другое существо, которое вы можете видеть в пределах 30 футов от себя, при условии, что вы являетесь дееспособным. Когда вы перемещаете проклятие таким образом, вы не восстанавливаете хиты от смерти ранее проклятого существа.`,
    ...
    'Небожитель': {
      ...
      descriptions: {
        'РАСШИРЕННЫЙ СПИСОК ЗАКЛИНАНИЙ': `1-й уровень, умение небожителя
...
Заклинания
1
лечение ран [cure wounds], направляющий снаряд [guiding bolt]
2
пылающий шар [flaming sphere], малое восстановление [lesser restoration]
3
дневной свет [daylight], возрождение [revivify]
4
страж веры [guardian of faith], огненная стена [wall of fire]
5
небесный огонь [flame strike], высшее восстановление [greater restoration]`,
        'ДОПОЛНИТЕЛЬНЫЕ ЗАГОВОРЫ': `1-й уровень, умение небожителя
Вы узнаёте заговоры свет [light] и священное пламя [sacred flame]. Для вас они считаются заговорами колдуна и не учитываются при подсчёте известных вам заговоров.`,
        'ЛЕЧАЩИЙ СВЕТ': `1-й уровень, умение небожителя
...
Бонусным действием вы можете вылечить одно существо, которое вы можете видеть в 60 футах, потратив кости из вашего набора. Максимальное количество костей, которые вы можете потратить единовременно, равно вашему модификатору Харизмы (минимум 1 кость). Бросьте кости, которые вы тратите, сложите их значения и восстанавливайте количество хитов, равное полученному значению. Вы восстанавливаете все потраченные кости после окончания продолжительного отдыха.`,
        'СИЯЮЩАЯ ДУША': `6-й уровень, умение небожителя
Ваша связь с Небожителем позволяет вам служить проводником для сияющей энергии. Вы получаете сопротивление урону излучением, и когда вы накладываете заклинание, которое наносит урон излучением или огнём, вы можете добавить модификатор Харизмы к одному броску урона излучением или огнём против одной из целей этого заклинания.`,
        'НЕБЕСНОЕ СОПРОТИВЛЕНИЕ': `10-й уровень, умение небожителя
Вы получаете временные хиты, когда вы заканчиваете короткий или продолжительный отдых. Эти временные хиты равны вашему уровню колдуна + ваш модификатор Харизмы. Кроме того, в конце отдыха выбирайте до пяти существ, которых вы можете видеть. Эти существа получают временные хиты, равные половине вашего уровня колдуна + ваш модификатор Харизмы.`,
        'ЖГУЧЕЕ ВОЗМЕЗДИЕ': `14-й уровень, умение небожителя
...
Использовав это умение, вы не можете использовать его повторно до окончания продолжительного отдыха.`,
    ...
    'Бездонный': {
      features: {
        1: ["Расширенный список заклинаний", "Щупальце из глубин", "Дар моря"],
...
Заклинания
1
волна грома [thunderwave], сотворение или уничтожение воды [create or destroy water]
2
порыв ветра [gust of wind], тишина [silence]
3
метель [sleet storm], молния [lightning bolt]
4
власть над водами [control water], призыв духа элементаля [summon elemental] (только вода)
5
длань Бигби [Bigby’s hand] (выглядит как щупальце), конус холода [cone of cold]`,
...
Использовав это умение, вы не сможете применить его повторно, пока не закончите короткий или продолжительный отдых.`,
    ...
    'Гений': {
      features: {
        1: ["Расширенный список заклинаний", "Сосуд гения"],
        6: ["Стихийный дар"],
        10: ["Спасительный сосуд"],
        14: ["Ограниченное желание"],
      },
      descriptions: {
        'Расширенный список заклинаний': `1-й уровень, умение гения
...
-
-`,
        'Сосуд гения': `1-й уровень, умение гения
...
Если сосуд будет уничтожен или вы потеряете его, вы можете провести часовую церемонию, чтобы получить замену от покровителя. Эта церемония может быть проведена как часть короткого или продолжительного отдыха. По её окончании предыдущий сосуд уничтожается, если он до сих пор существует. Этот сосуд исчезает в языках стихийной силы, когда вы умираете.`,
        'Стихийный дар': `6-й уровень, умение гения
...
Помимо этого вы можете бонусным действием даровать себе скорость полёта, равную 30 футам. Этот эффект длится 10 минут, и всё это время вы можете парить. Вы можете использовать бонусное действие подобным образом количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Спасительный сосуд': `10-й уровень, умение гения
...
Также кто угодно (включая вас), оставаясь в сосуде минимум 10 минут, получает все преимущества короткого отдыха. Помимо этого, кто угодно может добавить ваш бонус мастерства к количеству восстанавливаемых хитов, если тратит Кости Хитов во время этого короткого отдыха.`,
        'Ограниченное желание': `14-й уровень, умение гения
...
Использовав это умение, вы больше не сможете применить его повторно, пока не закончите 1к4 продолжительных отдыхов.`,
  ...
  'Монах': {
    'Путь открытой ладони': {
      ...
      descriptions: {
        'ТЕХНИКИ ОТКРЫТОЙ ЛАДОНИ': `3-й уровень, умение пути открытой ладони
...
Цель не может совершать реакции до конца вашего следующего хода.`,
        'ИСЦЕЛЕНИЕ ТЕЛА': `6-й уровень, умение пути открытой ладони
Вы получаете способность лечить себя. Вы можете действием восстановить количество хитов, равное вашему утроенному уровню монаха. Вы должны завершить продолжительный отдых, прежде чем сможете использовать это умение снова.`,
        'УМИРОТВОРЕНИЕ': `11-й уровень, умение пути открытой ладони
Вы можете совершить специальную медитацию, окружающую вас аурой мира. В конце продолжительного отдыха вы получаете эффект заклинания убежище [sanctuary], длящийся до начала вашего следующего продолжительного отдыха (эффект может окончиться ранее, согласно описанию заклинания). Сл спасброска от заклинания равна 8 + ваш модификатор Мудрости + ваш бонус мастерства.`,
        'ДРОЖАЩАЯ ЛАДОНЬ': `17-й уровень, умение пути открытой ладони
Вы получаете возможность создавать смертельные колебания в чужом теле. Если вы попадёте по существу безоружным ударом, вы можете потратить 3 очка ци, чтобы создать неуловимые колебания в его теле, которые длятся в течение количества суток, равного вашему уровню монаха. Колебания безвредны, пока вы не остановите их действием. Для того чтобы остановить их, цель должна находится на одном плане существования с вами. Когда вы используете это действие, существо должно совершить спасбросок Телосложения. В случае успеха цель получает урон некротической энергией 10к10, а в случае провала её хиты опускаются до 0. Вы можете держать одновременно только одно существо под действием «Дрожащей ладони». Вы можете решить закончить колебания без вреда, не тратя действие.`,
    ...
    'Путь тени': {
      ...
      descriptions: {
        'ТЕХНИКА ТЕНИ': `3-й уровень, умение пути тени
Вы можете использовать свою ци, чтобы дублировать эффекты некоторых заклинаний. Вы можете действием использовать 2 очка ци, чтобы наложить бесследное передвижение [pass without trace], тёмное зрение [darkvision], тишину [silence] или тьму [darkness], не требуя материальные компоненты. Кроме того, вы получаете заговор малая иллюзия [minor illusion], если вы еще не знаете его.`,
        'ШАГ ТЕНИ': `6-й уровень, умение пути тени
Вы получаете возможность шагнуть из одной тени в другую. Если вы находитесь в темноте или пространстве с тусклым освещением, вы можете бонусным действием телепортироваться на 60 футов в другое тусклое или тёмное свободное пространство, которое видите. Свою первую рукопашную атаку до конца текущего хода вы совершите с преимуществом.`,
        'ПЛАЩ ТЕНЕЙ': `11-й уровень, умение пути тени
Вы узнаёте, как становиться единым с тенью. Когда вы находитесь в области с тусклым освещением или в темноте, вы можете действием стать невидимым. Вы остаётесь невидимыми до тех пор, пока не совершите атаку, не наложите заклинание, или не окажетесь в области яркого света.`,
        'ОППОРТУНИСТ': `17-й уровень, умение пути тени
Вы узнаёте, как использовать мгновенное отвлечение цели, по которой попала атака. Если по существу в радиусе 5 футов от вас попала атака, совершенная другим существом, но не вами, вы можете реакцией совершить по нему рукопашную атаку.`,
    ...
    'Путь четырёх стихий': {
      ...
      descriptions: {
        'АДЕПТ СТИХИЙ': `3-й уровень, умение пути четырёх cтихий
...
Формирование текущей реки. Вы можете действием потратить 1 очко ци, чтобы выбрать область льда или воды в пространстве с длиной стороны не больше 30 футов, в пределах 120 футов от себя. Вы можете превратить в этой области воду в лёд и наоборот, и вы можете придавать льду в этой области любую форму. Вы можете повысить или понизить уровень льда, создать или заполнить углубление, возвести или сравнять стену, или создать ледяной столб. Размер любого изменения не может превышать половину наибольшей стороны области. Например, если вы изменяете пространство с длиной стороны в 30 футов, можно создать столб до 15 футов в высоту, поднять или опустить высоту области до 15 футов, вырыть углубление до 15 футов, и так далее. Вы не можете замуровать существо в лёд или причинить этим воздействием другому существу урон.`,
    ...
    'Путь кэнсэя': {
      features: {
        ...
        11: ["ЗАОСТРЕННЫЙ КЛИНОК"],
        17: ["БЕЗОШИБОЧНАЯ ТОЧНОСТЬ"],
      },
      descriptions: {
        'ПУТЬ КэНСЕЯ': `3-й уровень, умение пути кэнсэя
...
Путь кисти. Вы получаете владение инструментами каллиграфа или художника на ваш выбор.`,
        'ЕДИНСТВО С КЛИНКОМ': `6-й уровень, умение пути кэнсэя
...
Ловкий удар. Когда вы попадаете по цели оружием кэнсэя, вы можете потратить 1 очко ци, чтобы нанести цели дополнительный урон этим оружием, равный вашей кости боевых искусств. Вы можете использовать это умение только один раз за каждый свой ход.`,
        'ЗАОСТРЕННЫЙ КЛИНОК': `11-й уровень, умение пути кэнсэя
...
Бонус длится 1 минуту или до тех пор, пока вы снова не используете это умение. Это умение не влияет на магическое оружие, у которого уже есть бонус к броскам атаки и урона.`,
        'БЕЗОШИБОЧНАЯ ТОЧНОСТЬ': `17-й уровень, умение пути кэнсэя
...
Вы можете использовать это умение только один раз за каждый свой ход.`,
    ...
    'Путь пьяного мастера': {
      ...
      descriptions: {
        'ДОПОЛНИТЕЛЬНЫЕ ВЛАДЕНИЯ': `3-й уровень, умение пути пьяного мастера
Вы получаете владение навыком Выступление, если у вас его ещё нет. Ваша техника боевого искусства соединяет боевые тренировки с точностью танцора и выходками шута. Вы также получаете владение инструментами пивовара, если у вас его ещё нет.`,
        'ТЕХНИКА ПЬЯНИЦЫ': `3-й уровень, умение пути пьяного мастера
Вы учитесь быстро поворачиваться во время использования «Шквала ударов». Когда вы используете «Шквал ударов», то получаете все преимущества от Отхода, а ваша скорость ходьбы увеличивается на 10 футов до конца этого хода.`,
        'ПЬЯНАЯ ПОХОДКА': `6-й уровень, умение пути пьяного мастера
...
Перенаправить атаку. Когда существо промахивается по вам рукопашной атакой, вы можете реакцией потратить 1 очко ци, чтобы эта атака попала по одному существу по вашему выбору, которое вы можете видеть в радиусе 5 футов от вас, кроме атакующего.`,
        'УДАЧА ПЬЯНИЦЫ': `11-й уровень, умение пути пьяного мастера
Удача улыбается вам именно тогда, когда вы готовы провалиться в небытие. Совершая проверку характеристик, бросок атаки или спасбросок с помехой, вы можете использовать 2 очка ци, чтобы отменить помеху на этот бросок.`,
        'ОПЬЯНЯЮЩАЯ ЯРОСТЬ': `17-й уровень, умение пути пьяного мастера
Вы получаете возможность нанести ошеломляющее число атак против группы противников. Когда вы используете «Шквал ударов», вы можете совершить до трех дополнительных атак (до пяти атак «Шквала ударов» в общем), при условии, что все атаки «Шквала ударов» должны быть нацелены на разных существ в этом ходу.`,
    ...
    'Путь солнечной души': {
      ...
      descriptions: {
        'ЛУЧ СИЯЮЩЕГО СОЛНЦА': `3-й уровень, умение пути солнечной души
...
Когда вы получаете умение «Дополнительная атака», эта особая атака может использоваться вместо любых из атак, которые вы совершаете в качестве части действия Атака.`,
        'УДАР ПЫЛАЮЩЕЙ ДУГИ': `6-й уровень, умение пути солнечной души
...
Вы можете потратить дополнительное очко ци, чтобы наложить огненные ладони [burning hands] более высокого уровня. Каждое дополнительное очко ци поднимает уровень заклинания на 1. Максимальное количество очков ци (2 плюс дополнительные очки), которые могут быть потрачены на заклинание, равно половине вашего уровня монаха.`,
        'ПЫЛАЮЩИЙ СОЛНЕЧНЫЙ ВЗРЫВ': `11-й уровень, умение пути солнечной души
...
Вы можете увеличить урон сферы, потратив очки ци. Каждое очко увеличивает урон на 2к6 вплоть до максимума в 3 потраченных очка.`,
        'СОЛНЕЧНЫЙ ЩИТ': `17-й уровень, умение пути солнечной души
...
Если во время сияния по вам попадает рукопашной атакой существо, вы можете реакцией нанести этому существу урон излучением. Урон излучением равен 5 + ваш модификатор Мудрости.`,
    ...
    'Путь астрального тела': {
      ...
      descriptions: {
        'Руки астрального тела': `3-й уровень, умение пути астрального тела
...
Когда будете выбирать этот путь, придумайте особенность, выделяющую вашего монаха. Одержим ли он чем-то? Ведут ли его справедливость или личные мотивы? Любая мотивация может отражаться на вашем астральном теле.`,
        'Лик астрального тела': `6-й уровень, умение пути астрального тела
...
Слово духа. Когда вы говорите, вы можете направить свои слова к существу по вашему выбору, которое вы можете видеть в пределах 60 футов, так, что вас услышит только это существо. В качестве альтернативы вы можете усилить свой голос настолько, что все существа в пределах 600 футов смогут услышать вас.`,
        'Торс астрального тела': `11-й уровень, умение пути астрального тела
...
Усиленные руки. Один раз в свой ход, когда вы попадаете атакой руками астрального тела, вы можете нанести дополнительный урон цели, равный броску вашей кости боевого искусства.`,
        'Пробуждение астрального тела': `17-й уровень, умение пути астрального тела
...
Град астральных ударов. Каждый раз, когда вы используете умение «Дополнительная атака», чтобы атаковать дважды, вместо этого вы можете атаковать трижды, совершая все атаки с помощью рук астрального тела.`,
    ...
    'Путь милосердия': {
      ...
      descriptions: {
        'Орудия милосердия': `3-й уровень, умение пути милосердия
...
6
Бабочка`,
        'Исцеляющая рука': `3-й уровень, умение пути милосердия
...
Когда вы используете «Шквал ударов», вы можете заменить один из безоружных ударов использованием этого умения без затраты очков ци на исцеление.`,
        'Повреждающая рука': `3-й уровень, умение пути милосердия
Вы используете свою энергию ци для нанесения ран. Когда вы попадаете по существу безоружным ударом, вы можете потратить 1 очко ци, чтобы нанести дополнительный урон некротической энергией, равный броску кости боевых искусств + ваш модификатор Мудрости. Вы можете использовать это умение только один раз за ход.`,
        'Прикосновение целителя': `6-й уровень, умение пути милосердия
...
Когда вы используете «Повреждающую руку» на существе, вы можете сделать это существо отравленным до конца вашего следующего хода.`,
        'Шквал исцеления и повреждения': `11-й уровень, умение пути милосердия
...
Кроме того, когда вы совершаете безоружный удар «Шквалом ударов», вы можете использовать «Повреждающую руку» вместе с этим ударом без затраты очков ци на эффекты «Повреждающей руки». Вы всё ещё можете использовать «Повреждающую руку» только один раз за ход.`,
        'Рука абсолютного милосердия': `17-й уровень, умение пути милосердия
...
Использовав это умение, вы не сможете использовать его повторно, пока не закончите продолжительный отдых.`,
  ...
  'Паладин': {
    'Клятва преданности': {
      ...
      descriptions: {
        'ДОГМАТЫ ПРЕДАННОСТИ': `Хотя точные слова и смысл клятвы преданности варьируются, паладины данной клятвы разделяют следующие принципы:
...
Долг. Отвечайте за свои действия и их последствия, защищая тех, кого оберегаете, и подчиняйтесь тем, кто имеет власть над вами.`,
        'ЗАКЛИНАНИЯ КЛЯТВЫ': `3-й уровень, умение клятвы преданности
...
5
малое восстановление [lesser restoration], область истины [zone of truth]
9
маяк надежды [beacon of hope], рассеивание магии [dispel magic]
13
свобода перемещения [freedom of movement], страж веры [guardian of faith]
17
небесный огонь [flame strike], общение [commune]`,
        'БОЖЕСТВЕННЫЙ КАНАЛ': `3-й уровень, умение клятвы преданности
...
Изгнанные существа должны весь свой ход пытаться убежать от вас так далеко, как только могут, и не могут добровольно переместиться в пространство, находящееся в пределах 30 футов от вас. Также они не могут совершать реакции. Из всех действий они могут совершать только Рывок и попытки избежать эффекта, не дающего им перемещаться. Если же двигаться некуда, существа могут использовать действие Уклонение.`,
        'АУРА ПРЕДАННОСТИ': `7-й уровень, умение клятвы преданности
Вы и дружественные вам существа в пределах 10 футов от вас не могут быть очарованы, пока вы находитесь в сознании. На 18-м уровне радиус ауры увеличивается до 30 футов.`,
        'ЧИСТОТА ДУХА': `15-й уровень, умение клятвы преданности
Вы всегда находитесь под эффектом заклинания защита от зла и добра [protection from evil and good].`,
        'СВЯТОЙ НИМБ': `20-й уровень, умение клятвы преданности
...
Будь светом. Будь маяком великолепия для тех, кто живёт в отчаянии. Пусть свет твоей отваги и мужества сияет в твоих делах.`,
        'ЗАКЛИНАНИЯ КЛЯТВЫ': `3-й уровень, умение клятвы древних
Вы получаете заклинания клятвы на указанных уровнях паладина.
ЗАКЛИНАНИЯ КЛЯТВЫ ДРЕВНИХ
Уровень паладина
Заклинания
3
опутывающий удар [ensnaring strike], разговор с животными [speak with animals]
5
лунный луч [moonbeam], туманный шаг [misty step]
9
защита от энергии [protection from energy], рост растений [plant growth]
13
град [ice storm], каменная кожа [stoneskin]
17
древесный путь [tree stride], общение с природой [commune with nature]`,
        'БОЖЕСТВЕННЫЙ КАНАЛ': `3-й уровень, умение клятвы древних
Когда вы даёте эту клятву, вы получаете следующие два варианта использования «Божественного канала».
...
Если истинная форма существа скрыта иллюзией, изменением облика, или другим эффектом, скрывающим её, то она раскрывается, когда существо изгоняется.`,
        'АУРА ОПЕКИ': `7-й уровень, умение клятвы древних
...
На 18-м уровне радиус ауры увеличивается до 30 футов.`,
        'БЕССМЕРТНЫЙ СТРАЖ': `15-й уровень, умение клятвы древних
Если ваши хиты опускаются до 0, но вы не были убиты, вы можете решить, чтобы вы вместо этого остались с 1 хитом. Использовав это умение, вы не можете повторно его использовать, пока не окончите продолжительный отдых. Кроме того, вы не получаете недостатков от большого возраста, и не можете быть состарены магией.`,
        'ДРЕВНИЙ ЧЕМПИОН': `20-й уровень, умение клятвы древних
...
Возмещение. Если мои враги сеют разруху в мире, то это потому, что мне не удалось их остановить. Я должен помочь тем, кто пострадал от их злодеяний.`,
        'ЗАКЛИНАНИЯ КЛЯТВЫ': `3-й уровень, умение клятвы мести
Вы получаете заклинания клятвы на указанных уровнях паладина.
ЗАКЛИНАНИЯ КЛЯТВЫ МЕСТИ
Уровень паладина
Заклинания
3
метка охотника [hunter’s mark], порча [bane]
5
туманный шаг [misty step], удержание личности [hold person]
9
защита от энергии [protection from energy], ускорение [haste]
13
изгнание [banishment], переносящая дверь [dimension door]
17
наблюдение [scrying], удержание чудовища [hold monster]`,
        'БОЖЕСТВЕННЫЙ КАНАЛ': `3-й уровень, умение клятвы мести
Когда вы даёте эту клятву, вы получаете следующие два варианта использования «Божественного канала».
...
Обет вражды. Вы можете бонусным действием произнести слова обета вражды по отношению к существу, которое вы можете видеть, и которое находится в пределах 10 футов от вас, используя «Божественный канал». В течение 1 минуты, пока его хиты не опускаются до 0, или оно не потеряет сознание, вы совершаете броски атаки по нему с преимуществом.`,
        'НЕУМОЛИМЫЙ МСТИТЕЛЬ': `7-й уровень, умение клятвы мести
Ваше сверхъестественное внимание помогает вам предотвратить бегство врага. Если вы попадаете по существу провоцированной атакой, вы можете частью этой реакции переместиться на расстояние, равное половине своей скорости. Это перемещение не провоцирует атаки.`,
        'ДУША МЕСТИ': `15-й уровень, умение клятвы мести
Суть вашего «Обета вражды» даёт вам большую власть над врагом. Когда существо, находящееся под действием вашего «Обета вражды», совершает атаку, вы можете реакцией совершить рукопашную атаку оружием по этому существу, если оно находится в пределах досягаемости.`,
        'МСТЯЩИЙ АНГЕЛ': `20-й уровень, умение клятвы мести
...
Использовав это умение, вы можете использовать его повторно только после окончания продолжительного отдыха.`,
    ...
    'Клятва искупления': {
      ...
      descriptions: {
        'ДОГМАТЫ ИСКУПЛЕНИЯ': `Догматы Клятвы Искупления ведут паладина дорогой высоких идеалов мира и правосудия.
...
Мудрость. Твоё сердце и разум должны быть чисты, ибо в конце концов тебе придется признать поражение. И хотя каждое существо можно спасти, некоторые зашли так далеко по пути зла, что тебе не остаётся ничего иного, кроме как закончить их жизнь ради большего блага. Любое такое действие нужно тщательно взвешивать и полностью понимать последствия, но приняв решение, нужно следовать ему, будучи уверенным в справедливости своего пути.`,
        'ЗАКЛИНАНИЯ КЛЯТВЫ': `3-й уровень, умение клятвы искупления
Вы получаете заклинания клятвы на указанных уровнях паладина.
Уровень
Заклинание
3
убежище [sanctuary], усыпление [sleep]
5
умиротворение [calm emotions], удержание личности [hold person]
9
контрзаклинание [counterspell], гипнотический узор [hypnotic pattern]
13
Отилюков упругий шар [Otiluke’s resilient sphere], каменная кожа [stoneskin]
17
удержание чудовища [hold monster], силовая стена [wall of force]`,
        'БОЖЕСТВЕННЫЙ КАНАЛ': `3-й уровень, умение клятвы искупления
...
Возмездие жестокости. Вы можете использовать свой «Божественный канал», чтобы дать отпор жестоким врагам. Сразу же после того, как атакующий в пределах 30 футов от вас наносит урон атакой существу, отличному от вас, вы можете реакцией заставить атакующего совершить спасбросок Мудрости. При провале атакующий получает столько урона излучением, сколько он нанёс урона. При успехе он получает половину этого урона.`,
        'АУРА Защитника': `7-й уровень, умение клятвы искупления
Вы можете прикрыть других от вреда ценой собственных хитов. Когда существо в 10 футах от вас получает урон, вы можете реакцией волшебным образом получить этот урон вместо него. Это умение не переносит никакие другие эффекты, которые могут сопровождать урон и его невозможно уменьшить никаким способом. На 18-м уровне радиус этой ауры увеличивается до 30 футов.`,
        'ДУХ ЗАЩИТНИК': `15-й уровень, умение клятвы искупления
Святой дух лечит ваши раны в бою. Вы восполняете хиты в размере 1к6 + половина вашего уровня паладина, если в конце вашего хода в бою у вас менее половины ваших хитов и вы не недееспособны.`,
        'ЭМИССАР ИСКУПЛЕНИЯ': `20-й уровень, умение клятвы искупления
...
5
удержание личности [hold person], божественное оружие [spiritual weapon]
9
проклятие [bestow curse], ужас [fear]
13
подчинение зверя [dominate beast], каменная кожа [stoneskin]
17
облако смерти [cloudkill], подчинение личности [dominate person]`,
...
Направленный удар. Вы можете использовать свой «Божественный канал», чтобы наносить удары со сверхъестественной точностью. Когда вы проводите атаку, вы можете использовать свой «Божественный канал», чтобы получить бонус +10 к этому броску. Вы можете использовать это свойство уже после того, как увидите результат броска, но обязаны сделать выбор до того, как Мастер объявит о попадании или промахе атаки.`,
        'АУРА ПОКОРЕНИЯ': `7-й уровень, умение клятвы покорения
...
Если существо испугано вами, его скорость падает до 0, пока оно находится в области действия ауры, и существо получает урон психической энергией, равный половине вашего уровня паладина, если начинает свой ход там. На 18-м уровне радиус этой ауры увеличивается до 30 футов.`,
        'ПРЕЗРИТЕЛЬНОЕ ВОЗМЕЗДИЕ': `15-й уровень, умение клятвы покорения
...
Когда существо попадает по вам атакой, это существо получает урон психической энергией, равный вашему модификатору Харизмы (минимум 1), если вы не недееспособны.`,
        'НЕПОБЕДИМЫЙ ПОКОРИТЕЛЬ': `20-й уровень, умение клятвы покорения
...
Использовав это умение, вы не можете использовать его повторно до окончания продолжительного отдыха.`,
    ...
    'Клятва смотрителей': {
      features: {
        3: ["Заклинания клятвы", "Божественный канал"],
        7: ["Аура стража"],
        15: ["Бдительное возмездие"],
        20: ["Оплот смертных"],
      },
      descriptions: {
        'Догматы смотрителей': `Паладин, принявший клятву смотрителей, поклялся защищать смертных от угроз из других миров.
...
Дисциплина. Ты — это защита от бесконечных угроз, скрывающихся далеко за звездами. Твой ум и клинок должны оставаться острыми, чтобы пережить то, что придет издалека.`,
        'Заклинания клятвы': `3-й уровень, умение клятвы смотрителей
...
Заклинание
3
обнаружение магии [detect magic], сигнал тревоги [alarm]
5
видение невидимого [see invisibility], лунный луч [moonbeam]
9
контрзаклинание [counterspell], необнаружимость [nondetection]
13
аура очищения [aura of purity], изгнание [banishment]
17
наблюдение [scrying], удержание чудовища [hold monster]`,
        'Божественный канал': `3-й уровень, умение клятвы смотрителей
...
Изгнанные существа должны весь свой ход пытаться убежать от вас так далеко, как только могут, и не могут добровольно переместиться в пространство, находящееся в пределах 30 футах от вас. Из всех действий они могут совершать только Рывок или пытаться избежать эффекта, не дающего им перемещаться. Если же двигаться некуда, существа могут использовать Уклонение.`,
        'Аура стража': `7-й уровень, умение клятвы смотрителей
...
На 18-м уровне радиус ауры увеличивается до 30 футов.`,
        'Бдительное возмездие': `15-й уровень, умение клятвы смотрителей
Вы научились магическим образом наказывать любого, кто посмеет использовать чары против вас или ваших товарищей. Каждый раз, когда вы или существо, которое вы можете видеть в пределах 30 футов, преуспевает в спасброске Интеллекта, Мудрости или Харизмы, вы можете реакцией нанести 2к8 + ваш модификатор Харизмы урона силовым полем тому, кто заставил совершить этот спасбросок.`,
        'Оплот смертных': `20-й уровень, умение клятвы смотрителей
...
Использовав это бонусное действие, вы не можете сделать это вновь, пока не закончите продолжительный отдых или не потратите ячейку заклинаний 5-го уровня на повторное использование этого умения.`,
  ...
  'Плут': {
    'Вор': {
      ...
      descriptions: {
        'БЫСТРЫЕ РУКИ': `3-й уровень, умение вора
Вы можете бонусным действием, предоставленным вашим Хитрым действием, совершить проверку Ловкости (Ловкость рук), использовать воровские инструменты, чтобы обезвредить ловушку или вскрыть замок, или же совершить действие Использование предмета.`,
        'ФОРТОЧНИК': `3-й уровень, умение вора
...
Кроме того, когда вы совершаете прыжок с разбега, расстояние, которое вы преодолеваете, увеличивается на число футов, равное вашему модификатору Ловкости.`,
        'ВЫСОКАЯ СКРЫТНОСТЬ': `9-й уровень, умение вора
Вы совершаете с преимуществом проверки Ловкости (Скрытность), если в этом ходу перемещались не более чем на половину своей скорости.`,
        'ИСПОЛЬЗОВАНИЕ МАГИЧЕСКИХ ПРЕДМЕТОВ': `13-й уровень, умение вора
Вы узнаёте достаточно о магических процессах, чтобы импровизировать при использовании предметов, даже если раньше вы не умели ими пользоваться. Вы игнорируете все требования класса, расы и уровня при использовании магических предметов.`,
        'ВОРОВСКИЕ РЕФЛЕКСЫ': `17-й уровень, умение вора
Вы обретаете большой опыт организации засад и быстрого отступления при опасности. Вы можете совершить два хода во время первого раунда боя. Совершите первый ход согласно своей нормальной инициативе, и второй ход с инициативой на 10 меньше. Вы не можете использовать это умение, если захвачены врасплох.`,
    ...
    'Убийца': {
      ...
      descriptions: {
        'ДОПОЛНИТЕЛЬНЫЕ ВЛАДЕНИЯ': `3-й уровень, умение убийцы
Вы получаете владение набором для грима и инструментами отравителя.`,
        'ЛИКВИДАЦИЯ': `3-й уровень, умение убийцы
Вы становитесь смертоносными для врагов. Вы совершаете с преимуществом броски атаки по всем существам, которые ещё не совершали ход в этом бою. Кроме того, все попадания по существам, захваченным врасплох, являются критическими попаданиями.`,
        'МАСТЕР ПРОНИКНОВЕНИЯ': `9-й уровень, умение убийцы
...
После принятия новой личности в качестве маскировки другие существа верят, что вы являетесь этой личностью, пока не подадите очевидный повод решить обратное.`,
        'САМОЗВАНЕЦ': `13-й уровень, умение убийцы
...
Ваши уловки не видны для случайного наблюдателя. Если осторожное существо подозревает что-то неладное, вы совершаете с преимуществом все проверки Харизмы (Обман), чтобы избежать обнаружения.`,
        'СМЕРТЕЛЬНЫЙ УДАР': `17-й уровень, умение убийцы
Вы становитесь мастером мгновенной смерти. Если вы атакуете и попадаете по существу, захваченному врасплох, оно должно совершить спасбросок Телосложения (Сл 8 + ваш модификатор Ловкости + ваш бонус мастерства). Проваленный спасбросок означает удвоение урона от вашей атаки по этому существу.`,
    ...
    'Мистический ловкач': {
      features: {
        3: ["ИСПОЛЬЗОВАНИЕ ЗАКЛИНАНИЙ", "УЛУЧШЕННАЯ ВОЛШЕБНАЯ РУКА"],
        9: ["МАГИЧЕСКАЯ ЗАСАДА"],
        13: ["МНОГОГРАННЫЙ ЛОВКАЧ"],
        17: ["ВОР ЗАКЛИНАНИЙ"],
      },
      descriptions: {
        'ИСПОЛЬЗОВАНИЕ ЗАКЛИНАНИЙ': `3-й уровень, умение мистического ловкача
...
3
1`,
        'УЛУЧШЕННАЯ ВОЛШЕБНАЯ РУКА': `3-й уровень, умение мистического ловкача
...
Кроме того, вы можете использовать бонусное действие, предоставленное умением «Хитрое действие», для управления рукой.`,
        'МАГИЧЕСКАЯ ЗАСАДА': `9-й уровень, умение мистического ловкача
Если вы накладываете заклинание на существо, от которого скрыты, существо в этом ходу совершает с помехой спасброски от этого заклинания.`,
        'МНОГОГРАННЫЙ ЛОВКАЧ': `13-й уровень, умение мистического ловкача
Вы получаете возможность отвлекать цель своей волшебной рукой. В свой ход вы бонусным действием можете обозначить существо в пределах 5 футов от руки, наложенной этим заклинанием. Если вы так делаете, то до конца этого хода совершаете броски атаки по этому существу с преимуществом.`,
        'ВОР ЗАКЛИНАНИЙ': `17-й уровень, умение мистического ловкача
...
Вы бросаетесь в бой смело и без колебаний. Вы добавляете свой модификатор Харизмы к результату броска инициативы. Кроме того, теперь для использования скрытой атаки вам не требуется совершать с преимуществом бросок атаки по существу, если оно находится в 5 футах от вас, в пределах 5 футов от вас больше нет других существ и у вас нет помехи на этот бросок. Все прочие правила для классового умения «Скрытая атака» применяются к вам как обычно.`,
        'ЩЕГОЛЬСТВО': `9-й уровень, умение дуэлянта
...
Если вы преуспеваете в этом состязании и существо не враждебно к вам, оно очаровано вами на 1 минуту. Пока существо очаровано, оно считает вас дружественным к себе. Этот эффект заканчивается немедленно, если вы или ваши союзники причините цели вред.`,
        'ЭЛЕГАНТНЫЙ МАНЁВР': `13-й уровень, умение дуэлянта
В свой ход вы можете использовать бонусное действие для того, чтобы совершить с преимуществом следующую проверку Ловкости (Акробатика) или Силы (Атлетика) на протяжении этого хода.`,
        'МАСТЕР ДУЭЛЯНТ': `17-й уровень, умение дуэлянта
...
Вы можете использовать действие Помощь бонусным действием. Когда вы используете действие Помощь союзнику в атаке существа, цель этой атаки может быть в 30 футах от вас, а не в 5 футах, если цель может видеть или слышать вас.`,
        'ПРОНИЦАТЕЛЬНЫЙ МАНИПУЛЯТОР': `9-й уровень, умение комбинатора
...
По усмотрению Мастера, вы также можете раскрыть для себя часть истории существа или одну из его черт характера, если таковые имеются.`,
        'ПОДМЕНА': `13-й уровень, умение комбинатора
Вы можете заставить другое существо получить атаку, предназначенную вам. Когда вы являетесь целью атаки, и в радиусе 5 футов от вас есть существо, дающее вам укрытие от атаки, вы можете реакцией перенаправить атаку с вас на это существо.`,
        'ДУША ОБМАНА': `17-й уровень, умение комбинатора
Ваши мысли нельзя прочитать телепатией или другими средствами, если вы не позволите. Вы можете подменить свои мысли на ложные, совершив проверку Харизмы (Обмана) против проверки Мудрости (Проницательности) чтеца мыслей. Кроме того, неважно, что вы говорите, магия, определяющая ложь, покажет, что вы правдивы, если вы того захотите, и вас нельзя принудить сказать правду с помощью магии.`,
    ...
    'Скаут': {
      ...
      descriptions: {
        'ЗАЧИНЩИК': `3-й уровень, умение скаута
К вам трудно подобраться во время боя. Вы можете реакцией переместиться на расстояние до половины вашей скорости, когда враг заканчивает свой ход в пределах 5 футов от вас. Это передвижение не вызывает провоцированных атак по вам.`,
        'ВЫЖИВАЛЬЩИК': `3-й уровень, умение скаута
...
Ваш бонус мастерства удваивается при любых проверках характеристик, совершённых с использованием любого из этих навыков.`,
        'ПРЕВОСХОДНАЯ МОБИЛЬНОСТЬ': `9-й уровень, умение скаута
Ваша скорость ходьбы увеличивается на 10 футов. Если у вас есть скорость лазания или плавания, это увеличение также затрагивает и их.`,
        'МАСТЕР ЗАСАД': `13-й уровень, умение скаута
...
В дополнение к этому, по первому существу, по которому вы попадаете в первый раунд боя, становится легче попасть другим: броски атаки по такой цели совершаются с преимуществом до начала вашего следующего хода`,
        'ВНЕЗАПНЫЙ УДАР': `17-й уровень, умение скаута
Вы можете наносить удары со смертоносной скоростью. Если в свой ход вы совершаете действие Атака, то можете совершить одну дополнительную атаку бонусным действием. К этой дополнительной атаке может применяться умение «Скрытая атака», даже если вы уже использовали его в этот ход, но вы не можете применять скрытую атаку против одной и той же цели более одного раза за ход.`,
    ...
    'Сыщик': {
      ...
      descriptions: {
        'СЛУХ НА ОБМАН': `3-й уровень, умение сыщика
...
Когда вы совершаете проверку Мудрости (Проницательность), чтобы распознать, обманывает ли существо, считайте выпавшие на к20 результаты «7» и ниже за «8».`,
        'ВНИМАТЕЛЬНЫЙ ВЗГЛЯД': `3-й уровень, умение сыщика
Вы можете бонусным действием совершить проверку Мудрости (Восприятие) с целью заметить спрятанное существо или предмет, либо проверку Интеллекта (Расследование) с целью найти или расшифровать улики.`,
        'ПРОНИЦАТЕЛЬНЫЙ БОЙ': `3-й уровень, умение сыщика
...
Этот эффект длится 1 минуту либо до тех пор, когда вы успешно используете это умение против другой цели.`,
        'НЕТОРОПЛИВЫЙ ВЗГЛЯД': `9-й уровень, умение сыщика
Вы совершаете с преимуществом все проверки Мудрости (Восприятие) и Интеллекта (Расследование), если в текущем ходу вы перемещаетесь не более, чем на половину своей скорости.`,
        'БЕЗОШИБОЧНЫЙ ВЗГЛЯД': `13-й уровень, умение сыщика
...
Вы можете использовать это умение количество раз, равное модификатору вашей Мудрости (минимум 1), и восстанавливаете потраченные использования после окончания продолжительного отдыха.`,
        'ВЗГЛЯД НА СЛАБОСТЬ': `17-й уровень, умение сыщика
Вы учитесь играть на слабостях существа, внимательно изучив его тактику и передвижения. Пока против существа действует ваше умение «Проницательный бой», урон от вашей «Скрытой атаки» против этого существа увеличиваются на 3к6.`,
    ...
    'Фантом': {
      ...
      descriptions: {
        'Шёпот мёртвых': `3-й уровень, умение фантома
Отголоски тех, кто умер, окутывают вас. Каждый раз, когда вы заканчиваете короткий или продолжительный отдых, призрачная сущность делится с вами знаниями, позволяя получить владение одним навыком или инструментом, которым вы ещё не владеете. Вы теряете это владение при использовании этого умения для замены владения на другое.`,
        'Могильные вопли': `3-й уровень, умение фантома
...
Вы можете использовать это умение количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Частица души усопшего': `9-й уровень, умение фантома
...
Действием вы можете уничтожить одну из своих безделушек вне зависимости от того, где она находится. Совершая это действие, вы можете задать один вопрос духу, заключенному в этой безделушке. Дух появляется перед вами и отвечает на языке, который он знал при жизни. Ответ не обязан быть правдивым, более того, он будет максимально кратким, так как дух стремится скорее покинуть этот мир. Дух знает только то, что он знал при жизни, по выбору Мастера.`,
        'Призрачная походка': `13-й уровень, умение фантома
...
Вы остаётесь в этой форме 10 минут или до тех пор, пока не окончите её бонусным действием. Чтобы использовать это умение вновь, вы должны закончить продолжительный отдых или уничтожить одну из своих безделушек в качестве части бонусного действия для активации «Призрачной походки».`,
        'Друг смерти': `17-й уровень, умение фантома
...
В конце продолжительного отдыха в вашей руке появляется безделушка, если у вас нет никаких безделушек, так как духи мертвецов тянутся к вам.`,
    ...
    'Клинок души': {
      ...
      descriptions: {
        'Псионическая сила': `3-й уровень, умение клинка души
В вас скрыт источник псионической энергии. Эта псионическая энергия представляется в виде костей псионической энергии к6. Количество имеющихся у вас костей псионической энергии равно вашему удвоенному бонусу мастерства. Эти кости питают ваши псионические силы, которые подробно описаны ниже.
...
Когда вы впервые используете эту способность после окончания продолжительного отдыха, вы не расходуете кость псионической энергии. Во всех остальных случаях, когда вы используете способность, ваша кость расходуется.`,
        'Психические клинки': `3-й уровень, умение клинка души
...
После того, как вы атакуете этим клинком, вы можете бонусным действием совершить рукопашную или дальнобойную атаку оружием, используя второй психический клинок при условии, что у вас свободна другая рука для его создания. Кость урона этой бонусной атаки равна 1к4, а не 1к6.`,
        'Клинки души': `9-й уровень, умение клинка души
...
Психическая телепортация. Бонусным действием вы проявляете один из своих психических клинков, расходуете кость псионической энергии и бросаете её, после чего вы мечете клинок в видимое вами свободное пространство на количество футов, не превышающее 10-кратный результат броска кости псионической энергии. После этого вы телепортируетесь в это пространство, а клинок исчезает.`,
        'Психическая завеса': `13-й уровень, умение клинка души
...
Когда вы используете действие подобным образом, вы не сможете сделать это вновь, пока не закончите продолжительный отдых или не потратите кость псионической энергии на повторное использование этого умения.`,
        'Раздирание разума': `17-й уровень, умение клинка души
...
Когда вы используете умение подобным образом, вы не сможете сделать это вновь, пока не закончите продолжительный отдых или не потратите 3 кости псионической энергии на повторное использование этого умения.`,
  ...
  'Следопыт': {
    'Охотник': {
      ...
      descriptions: {
        'ДОБЫЧА ОХОТНИКА': `3-й уровень, умение охотника
...
Убийца колоссов. Ваше упорство может повергнуть самых мощных врагов. Если вы попадаете по существу атакой оружием, это существо получает дополнительный урон 1к8, если его хиты уже ниже максимума. Вы можете причинить этот дополнительный урон только один раз в ход.`,
        'ОБОРОНИТЕЛЬНАЯ ТАКТИКА': `7-й уровень, умение охотника
Вы получаете одно из следующих умений на свой выбор:
...
Стальная воля. Вы совершаете с преимуществом спасброски от испуга.`,
        'МУЛЬТИАТАКА': `11-й уровень, умение охотника
Вы получаете одно из следующих умений на свой выбор:
...
Залп. Вы можете действием совершить дальнобойные атаки по любому количеству видимых вами существ, находящихся в пределах 10 футов от одной точки, и находящихся в пределах дистанции вашего оружия. У вас должны быть боеприпасы для каждой атаки, как обычно, и вы должны совершить отдельный бросок атаки для каждой цели.`,
        'УЛУЧШЕННАЯ ЗАЩИТА ОХОТНИКА': `15-й уровень, умение охотника
Вы получаете одно из следующих умений на свой выбор:
...
Увёртливость. Вы можете проворно уворачиваться от некоторых зональных эффектов, например, огненного дыхания красного дракона или заклинания молния [lightning bolt]. Если вы подвергаетесь эффекту, позволяющему совершить спасбросок Ловкости, чтобы получить только половину урона, вы вместо этого не получаете урона при успешном спасброске, или получаете лишь половину, если спасбросок был неудачным.`,
    ...
    'Повелитель зверей': {
      features: {
        3: ["СПУТНИК СЛЕДОПЫТА", "Первичный спутник"],
        7: ["ИСКЛЮЧИТЕЛЬНАЯ ДРЕССИРОВКА"],
        11: ["ЗВЕРИНАЯ ЯРОСТЬ"],
        15: ["ОБЩИЕ ЗАКЛИНАНИЯ"],
      },
      descriptions: {
        'СПУТНИК СЛЕДОПЫТА': `3-й уровень, умение повелителя зверей
...
Если Зверь умирает, вы можете получить другого, потратив 8 часов на волшебное связывание себя со Зверем, не враждебным к вам, того же вида, либо другого.`,
        'ИСКЛЮЧИТЕЛЬНАЯ ДРЕССИРОВКА': `7-й уровень, умение повелителя зверей
Если в ваш ход Зверь-спутник не нападает, вы можете бонусным действием приказать Зверю совершить Отход, Помощь, Рывок в его ход. Кроме того, атаки Зверя считаются магическими при определении преодоления сопротивления и иммунитета к немагическим атакам и урону.`,
        'ЗВЕРИНАЯ ЯРОСТЬ': `11-й уровень, умение повелителя зверей
Когда вы приказываете своему Зверю использовать действие Атака, он может совершить либо две атаки, либо действие Мультиатака, если у него оно есть.`,
        'ОБЩИЕ ЗАКЛИНАНИЯ': `15-й уровень, умение повелителя зверей
...
Повелитель зверей в «Книге игрока» образует мистическую связь с животным. В качестве альтернативы повелитель зверей может использовать приведённое ниже умение, чтобы сформировать связь с особым первичным зверем.`,
        'Первичный спутник': `3-й уровень, умение повелителя зверей, заменяющее умение «Спутник следопыта»
...
Когда вы закончите продолжительный отдых, вы можете призвать другого первичного зверя. Новый Зверь появляется в свободном пространстве в пределах 5 футов от вас, и вы выбираете его внешний вид и блок статистики. Если у вас уже есть Зверь от этого умения, то он исчезает, когда появляется новый. Зверь исчезает, если вы умираете.`,
    ...
    'Странник горизонта': {
      ...
      descriptions: {
        'МАГИЯ СТРАННИКОВ ГОРИЗОНТА': `3-й уровень, умение странника горизонта
...
круг телепортации [teleportation circle]`,
        'ОБНАРУЖИТЬ ПОРТАЛ': `3-й уровень, умение странника горизонта
...
Использовав это умение, вы не можете использовать его повторно до окончания короткого или продолжительного отдыха. Примеры планарных порталов см. в разделе «Путешествия по планам» главы 2 «Руководства Мастера».`,
        'ПЛАНАРНЫЙ ВОИН': `3-й уровень, умение странника горизонта
...
Когда вы достигаете 11-го уровня в этом классе, дополнительный урон увеличивается до 2к8.`,
        'ЭФИРНЫЙ ШАГ': `7-й уровень, умение странника горизонта
...
Использовав это умение, вы не можете использовать его повторно до окончания короткого или продолжительного отдыха.`,
        'ДАЛЁКИЙ УДАР': `11-й уровень, умение странника горизонта
...
Если вы атакуете по крайней мере двух различных существ за одно действие, вы можете тем же действием совершить одну дополнительную атаку против третьего существа.`,
        'СПЕКТРАЛЬНАЯ ЗАЩИТА': `15-й уровень, умение странника горизонта
Ваша способность перемещаться между планами позволяет скользить через планарные границы, чтобы уменьшать вред, наносимый вам во время боя. Когда вы получаете урон от атаки, вы можете реакцией дать себе сопротивление всему урону от этой атаки на этот ход.`,
    ...
    'Сумрачный охотник': {
      ...
      descriptions: {
        'МАГИЯ СУМРАЧНОГО ОХОТНИКА': `3-й уровень, умение сумрачного охотника
...
Вы получаете тёмное зрение в пределах 60 футов. Если вы имеете тёмное зрение от вашей расы, его дистанция увеличивается на 30 футов. Вы также сведущи в уклонении от существ, которые полагаются на тёмное зрение. Находясь во тьме, вы невидимы для любого существа, полагающегося на тёмное зрение, чтобы увидеть вас в этой темноте.`,
        'ЖЕЛЕЗНЫЙ РАЗУМ': `7-й уровень, умение сумрачного охотника
Вы отточили технику сопротивления влияющим на разум способностям вашей добычи. Вы получаете владение спасбросками Мудрости. Если у вас уже есть это владение, вы вместо этого можете получить владение спасброском Интеллекта или Харизмы (по вашему выбору).`,
        'ОХОТНИЧЬЯ ЯРОСТЬ': `11-й уровень, умение сумрачного охотника
Вы научились атаковать с такой неожиданной скоростью, что можете превратить промах в очередной удар. Один раз в каждый из своих ходов, когда вы промахиваетесь атакой оружием, вы можете совершить еще одну атаку оружием частью того же действия.`,
        'ТЕНЕВОЕ УКЛОНЕНИЕ': `15-й уровень, умение сумрачного охотника
...
Это умение необходимо использовать до того, как будет известен результат атаки.`,
    ...
    'Убийца чудовищ': {
      ...
      descriptions: {
        'МАГИЯ УБИЙЦЫ чудовищ': `3-й уровень, умение убийцы чудовищ
...
удержание чудовища [hold monster]`,
        'ОХОТНИЧЬИ ЧУВСТВА': `3-й уровень, умение убийцы чудовищ
...
Вы можете использовать это умение количество раз равное модификатору вашей Мудрости (минимум 1). Вы восстанавливаете все потраченные использования после окончания короткого или продолжительного отдыха.`,
        'ДОБЫЧА УБИЙЦЫ': `3-й уровень, умение убийцы чудовищ
...
Это преимущество действует до окончания вашего короткого или продолжительного отдыха. Оно заканчивается раньше, если вы выбираете другое существо.`,
        'СВЕРХЪЕСТЕСТВЕННАЯ ЗАЩИТА': `7-й уровень, умение убийцы чудовищ
Вы получаете дополнительную устойчивость против нападений вашей добычи на ваш ум и тело. Всякий раз, когда цель умения «Добыча убийцы» заставляет вас совершить спасбросок или когда вы совершаете проверку характеристики, чтобы перестать быть схваченным этой целью — добавьте 1к6 к броску.`,
        'ВРАГ ЗАКЛИНАТЕЛЯ': `11-й уровень, умение убийцы чудовищ
...
Использовав это умение, вы не можете использовать его повторно до окончания короткого или продолжительного отдыха.`,
        'КОНТРАТАКА УБИЙЦЫ': `15-й уровень, умение убийцы чудовищ
Вы получаете возможность контратаковать, когда ваша жертва пытается навредить вам. Если цель умения «Добыча убийцы» заставляет вас совершить спасбросок, то вы можете реакцией совершить одну атаку оружием по Добыче. Вы совершаете эту атаку непосредственно перед выполнением спасброска. Если атака попадает, вы автоматически проходите спасбросок в дополнение к обычным эффектам атаки.`,
    ...
    'Странник фей': {
      ...
      descriptions: {
        'Ужасающие удары': `3-й уровень, умение странника фей
...
Дополнительный урон увеличивается до 1к6, когда вы достигаете 11-го уровня в этом классе.`,
        'Магия странника фей': `3-й уровень, умение странника фей
...
На рассвете ваш цвет волос и кожи меняют свой цвет в соответствие сезону.`,
        'Потустороннее очарование': `3-й уровень, умение странника фей
...
В дополнение вы получаете владение одним из навыков по вашему выбору: Выступление, Обман или Убеждение.`,
        'Заманивающий трюк': `7-й уровень, умение странника фей
...
Кроме того, каждый раз, когда вы или существо, которое вы можете видеть в пределах 120 футов, преуспеваете в спасброске от очарования или испуга, вы можете реакцией заставить другое существо, которое вы можете видеть в пределах 120 футов, совершить спасбросок Мудрости против Сл ваших заклинаний. В случае провала цель становится очарованной или испуганной вами (по вашему выбору) на 1 минуту. Существо может повторять спасбросок в конце каждого своего хода, оканчивая на себе эффект при успехе.`,
        'Подкрепление фей': `11-й уровень, умение странника фей
...
Каждый раз, когда вы начинаете накладывать это заклинание, вы можете изменить его так, чтобы оно не требовало концентрации. Если вы решите это сделать, то его продолжительность составляет 1 минуту.`,
        'Туманный странник': `15-й уровень, умение странника фей
...
Кроме того, каждый раз, когда вы используете туманный шаг [misty step], вы можете взять с собой одно согласное существо, которое можете видеть в пределах 5 футов. Это существо телепортируется в свободное пространство по вашему выбору в пределах 5 футов от места назначения.`,
    ...
    'Хранитель роя': {
      ...
      descriptions: {
        'Собранный рой': `3-й уровень, умение хранителя роя
...
Рой перемещает вас на 5 футов по горизонтали в направлении по вашему выбору.`,
        'Магия хранителя роя': `3-й уровень, умение хранителя роя
...
Заклинания
3
волшебная рука [mage hand], огонь фей [faerie fire]
5
паутина [web]
9
газообразная форма [gaseous form]
...
нашествие насекомых [insect plague]`,
        'Извивающаяся волна': `7-й уровень, умение хранителя роя
...
Вы можете использовать это умение количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Могущественный рой': `11-й уровень, умение хранителя роя
...
Когда вы перемещаетесь «Собранным роем», он даёт вам половину укрытия до начала вашего следующего хода.`,
        'Растворение в рое': `15-й уровень, умение хранителя роя
...
Кроме того, помните, что внешний вид роя можно изменять самостоятельно, и не ограничивайтесь только одним вариантом. Возможно, облик духов будет меняется в зависимости от настроения следопыта или от времени года. Вам решать!`,
  ...
  'Чародей': {
    'Наследие драконьей крови': {
      ...
      descriptions: {
        'ДРАКОНИЙ ПРЕДОК': `1-й уровень, умение наследия драконьей крови
...
Кроме того, некоторые участки вашей кожи покрыты тонкой драконьей чешуёй. Если вы не носите доспехов, ваш Класс Доспеха равен 13 + модификатор Ловкости.`,
        'РОДСТВО СО СТИХИЕЙ': `6-й уровень, умение наследия драконьей крови
Когда вы накладываете заклинание, причиняющее урон вида, связанного с вашим драконьим предком, вы добавляете модификатор Харизмы к одному броску урона этого заклинания. В это же самое время вы можете потратить 1 единицу чародейства, чтобы получить сопротивление этому виду урона на 1 час.`,
        'КРЫЛЬЯ ДРАКОНА': `14-й уровень, умение наследия драконьей крови
...
Вы не можете призвать свои крылья, нося броню, если, конечно, броня не изготовлена специально для этого. Одежда, также не приспособленная под крылья, может быть уничтожена, когда вы призываете их.`,
        'ОБРАЗ ДРАКОНА': `18-й уровень, умение наследия драконьей крови
...
В любой момент до того как вы восстановите это умение, сразу после использования вами заклинания чародея как минимум 1-го уровня, Мастер может попросить вас бросить кость по таблице «Волна дикой магии». После этого вы восстанавливаете использование этого умения.`,
        'ПОДЧИНЕНИЕ УДАЧИ': `6-й уровень, умение дикой магии
Вы получаете возможность менять судьбу с помощью дикой магии. Когда другое существо, видимое вами, совершает бросок атаки, проверку характеристики или спасбросок, вы можете реакцией потратить 2 единицы чародейства и бросить 1к4. Результат броска станет бонусом или штрафом (на ваш выбор) к броску существа. Вы можете сделать это после броска существа, но до того, как начнут действовать эффекты от броска.`,
        'КОНТРОЛИРУЕМЫЙ ХАОС': `14-й уровень, умение дикой магии
Вы получаете толику контроля над волнами дикой магии. Каждый раз, когда вы совершаете бросок по таблице дикой магии, вы можете совершить два броска и использовать любой из двух.`,
        'РАЗРУШИТЕЛЬНЫЕ ЗАКЛИНАНИЯ': `18-й уровень, умение дикой магии
...
03-04
В течение минуты вы можете видеть невидимых существ, если у вас есть линия обзора до них.
05-06
В свободном пространстве в пределах 5 футов от вас появляется модрон, выбранный и контролируемый Мастером. Модрон исчезает через 1 минуту.
07-08
Вы накладываете огненный шар [fireball] как заклинание 3-го уровня с центром на себе.
09-10
Вы накладываете волшебную стрелу [magic missile] как заклинание 5-го уровня.
11-12
Бросьте 1к10. Ваш рост изменяется на количество дюймов, равное результату броска. Если бросок нечётный, вы уменьшаетесь. Если бросок чётный, вы растёте.
13-14
Вы накладываете заклинание смятение [confusion] с центром на себе.
15-16
В течение следующей минуты вы восстанавливаете по 5 хитов в начале каждого своего хода.
17-18
У вас вырастает длинная борода из перьев, которая остаётся, пока вы не чихнёте, и в этот момент перья разлетаются во все стороны.
19-20
Вы накладываете заклинание скольжение [grease] с центром на себе.
21-22
Существа получают помеху к спасброскам от следующего заклинания, которое вы наложите в течение следующей минуты, требующего совершить спасбросок.
23-24
Ваша кожа окрашивается в ярко-синий цвет. Заклинание снятие проклятья [remove curse] отменяет этот эффект.
25-26
На вашем лбу на минуту появляется глаз. В течение этого времени, вы совершаете с преимуществом проверки Мудрости (Восприятие), полагающиеся на зрение.
27-28
В течение следующей минуты все ваши заклинания со временем накладывания «1 действие» могут быть наложены бонусным действием.
29-30
Вы телепортируетесь на расстояние до 60 футов в свободное пространство по вашему выбору, которое видите.
31-32
Вы перемещаетесь на Астральный план до конца своего следующего хода, после чего вы вернётесь в пространство, ранее занимаемое, или ближайшее свободное пространство, если это пространство занято.
33-34
Урон от следующего заклинания, наносящего урон и наложенного вами в течение следующей минуты, будет максимальным.
35-36
Бросьте к10. Ваш возраст изменяется на число лет, равное броску. Если бросок нечётный, вы молодеете (минимум на 1 год). Если бросок чётный, вы стареете.
37-38
В пределах 60 футов от вас в свободном пространстве появляются 1к6 фламфов [flumph], контролируемых Мастером и напуганных вами. Они исчезают через 1 минуту.
39-40
Вы восстанавливаете 2к10 хитов.
41-42
Вы превращаетесь в горшок с цветами до начала своего следующего хода. Будучи растением, вы недееспособны и уязвимы для всех видов урона. Если ваши хиты опускаются до 0, ваш горшок раскалывается, и вы возвращаетесь в свою форму.
43-44
В течение следующей минуты вы можете в каждый свой ход бонусным действием телепортироваться на расстояние до 20 футов
45-46
Вы накладываете заклинание левитация [levitate] на себя.
47-48
В пределах 5 футов от вас появляется единорог [unicorn], контролируемый Мастером. Он исчезает через 1 минуту.
49-50
Вы не можете говорить в течение следующей минуты. Всякий раз, когда вы пытаетесь говорить, из вашего рта вылетают розовые пузырьки.
51-52
В течение следующей минуты рядом с вами парит призрачный щит, предоставляющий бонус +2 к КД и иммунитет к волшебной стреле.
53-54
Вы получаете иммунитет к воздействию алкоголя на ваш организм в течение следующих 5к6 дней.
55-56
У вас выпадают все волосы, но отрастают обратно за 24 часа.
57-58
В течение следующей минуты все легковоспламеняющиеся предметы, не несомые и не носимые другим существом, которых вы касаетесь, загораются.
59-60
Вы восстанавливаете самую низкоуровневую ячейку заклинания, потраченную вами.
61-62
В течение следующей минуты вы должны кричать, когда говорите.
63-64
Вы накладываете заклинание туманное облако [fog cloud] с центром на себе.
65-66
До трёх существ на ваш выбор в пределах 30 футов от вас получают урон электричеством 4к10.
67-68
Вы испуганы ближайшим к вам существом до конца своего следующего хода.
69-70
Все существа в пределах 30 футов от вас становятся невидимыми на 1 минуту. Невидимость прекращается, если существо совершает атаку или накладывает заклинание.
71-72
Вы получаете на 1 минуту сопротивление всем видам урона.
73-74
Случайное существо в пределах 60 футов от вас становится отравленным на 1к4 часа.
75-76
Вы в течение минуты излучаете яркий свет в радиусе 30 футов. Все существа, оканчивающие ход в пределах 5 футов от вас, становятся ослепшими до конца своего следующего хода.
77-78
Вы накладываете на себя заклинание превращение [polymorph]. Если вы проваливаете спасбросок, то на время действия заклинания превращаетесь в овцу.
79-80
В течение минуты в пределах 10 футов от вас в воздухе порхают иллюзорные бабочки и лепестки цветов.
81-82
Вы можете немедленно совершить одно дополнительное действие.
83-84
Все существа в пределах 30 футов от вас получают урон некротической энергией 1к10. Вы восстанавливаете хиты, равные сумме причинённого урона.
85-86
Вы накладываете заклинание отражения [mirror image].
87-88
Вы накладываете заклинание полёт [fly] на случайное существо в пределах 60 футов от вас.
89-90
Вы становитесь невидимым на 1 минуту. При этом другие существа не могут услышать вас. Невидимость оканчивается, если вы атакуете или накладываете заклинание.
91-92
Если вы погибнете в течение следующей минуты, то мгновенно вернётесь к жизни, как если бы вас воскресили заклинанием реинкарнация [reincarnate].
93-94
Ваш размер на 1 минуту увеличивается на одну категорию.
95-96
Вы и все существа в пределах 30 футов от вас получаете на 1 минуту уязвимость колющему урону.
97-98
В течение следующей минуты вы окружены тихой неземной музыкой.
99-00
Вы восстанавливаете все потраченные единицы чародейства.`,
      },
    },
    'Божественная душа': {
      features: {
      ...
      descriptions: {
        'БОЖЕСТВЕННАЯ МАГИЯ': `1-й уровень, умение божественной души
...
Использовав это умение, вы не можете использовать его повторно до окончания короткого или продолжительного отдыха.`,
        'УСИЛЕННОЕ ЛЕЧЕНИЕ': `6-й уровень, умение божественной души
Божественная энергия, проходящая через вас, может усилить лечащие заклинания. Всякий раз, когда вы или союзник в пределах 5 футов от вас совершаете бросок кости, чтобы определить количество хитов, которое восстанавливается заклинанием, вы можете потратить 1 единицу чародейства чтобы один раз перебросить любое количество костей, при условии, что вы не являетесь недееспособным. Вы можете использовать это умение только один раз за ход.`,
        'КРЫЛЬЯ ИЗ ДРУГОГО МИРА': `14-й уровень, умение божественной души
...
Крылья не исчезают до тех пор, пока вы не станете недееспособны, не умрёте или не рассеете их бонусным действием. Склонность, которую вы выбрали для своего умения «Божественная магия», определяет внешний вид спектральных крыльев: орлиные крылья для добра или закона, крылья летучей мыши для зла или хаоса и крылья стрекозы для нейтралитета.`,
        'НЕЗЕМНОЕ ВОССТАНОВЛЕНИЕ': `18-й уровень, умение божественной души
...
Использовав это умение, вы не можете использовать его повторно до окончания продолжительного отдыха.`,
    ...
    'Теневая магия': {
      ...
      descriptions: {
        'ГЛАЗА ТЬМЫ': `1-й уровень, умение теневой магии
Вы получаете тёмное зрение в пределах 120 футов. Когда вы достигаете 3-го уровня в этом классе, вы изучаете заклинание тьма [darkness], которое не учитывается при подсчёте известных вам заклинаний чародея. Кроме того, вы можете наложить его, потратив 2 единицы чародейства или ячейку заклинания. Если вы накладываете его с использованием единиц чародейства, вы можете видеть сквозь эту тьму, созданную заклинанием.`,
        'СИЛА МОГИЛЫ': `1-й уровень, умение теневой магии
...
После успешного спасброска вы не можете использовать это умение вновь до окончания продолжительного отдыха.`,
        'ГОНЧАЯ ДУРНОГО ЗНАМЕНИЯ': `6-й уровень, умение теневой магии
...
Гончая появляется в свободном пространстве по вашему выбору в пределах 30 футов от цели. Совершите бросок инициативы для гончей. В свой ход она может двигаться только к своей цели по самому прямому маршруту, и она может использовать своё действие только для атаки своей цели. Гончая может совершать провоцированные атаки, но только против своей цели. Кроме того, в то время как гончая находится в пределах 5 футов от цели, цель совершает с помехой спасброски против любого заклинания, которое вы накладываете. Гончая исчезает, если её хиты уменьшаются до 0, если хиты её цели уменьшены до 0 или спустя 5 минут.`,
        'ХОЖДЕНИЕ ПО ТЕНЯМ': `14-й уровень, умение теневой магии
Вы получаете способность переходить из одной тени в другую. Когда вы находитесь в тусклом свете или темноте вы можете бонусным действием волшебным образом телепортироваться на расстояние до 120 футов в свободное пространство, которое вы можете видеть, которое также находится в тусклом свете или темноте.`,
        'МРАЧНАЯ ФОРМА': `18-й уровень, умение теневой магии
...
Эффект заканчивается раньше, если вы становитесь недееспособны, умираете или если вы отмените его бонусным действием.`,
    ...
    'Штормовое колдовство': {
      ...
      descriptions: {
        'УСТА ВЕТРА': `1-й уровень, умение штормового колдовства
Тайная магия, которой вы повелеваете, наполняется стихией воздуха. Вы можете говорить, читать и писать на Первичном. Знание этого языка позволяет понимать и быть понятым теми, кто говорит на его диалектах: Акван, Ауран, Игнан и Терран.`,
        'БУРНАЯ МАГИЯ': `1-й уровень, умение штормового колдовства
Вы можете в свой ход бонусным действием заставить завихряющиеся порывы стихийного ветра на мгновение окружить вас прямо перед тем или прямо после того, как вы накладываете заклинание 1-го уровня или выше. Это позволяет вам отлететь на расстояние до 10 футов, не провоцируя атак.`,
        'СЕРДЦЕ ШТОРМА': `6-й уровень, умение штормового колдовства
...
Кроме того, каждый раз, когда вы начинаете накладывать заклинание 1-го уровня или выше, которое наносит урон звуком или электричеством, из вас выплёскивается магия шторма. Этот всплеск направлен в существ по вашему выбору, которых вы можете видеть в пределах 10 футов от вас, и наносит урон звуком или электричеством (выбирайте каждый раз, когда эта способность активируется), равный половине вашего уровня чародея.`,
        'УПРАВЛЕНИЕ ШТОРМОМ': `6-й уровень, умение штормового колдовства
...
Вы можете окончить этот эффект бонусным действием. Если ветрено, вы можете каждый раунд бонусным действием выбирать направление ветра в сфере с радиусом 100 футов с центром на вас. Ветер дует в этом направлении до конца вашего следующего хода. Это умение не изменяет скорость ветра.`,
        'ЯРОСТЬ ШТОРМА': `14-й уровень, умение штормового колдовства
Когда по вам попадают рукопашной атакой, вы можете реакцией нанести атакующему урон электричеством. Урон равен вашему уровню чародея. Атакующий должен также совершить спасбросок Силы против Сл вашего спасброска от заклинаний. При провале атакующего отталкивает по прямой линии на расстояние до 20 футов от вас.`,
        'ДУША ВЕТРА': `18-й уровень, умение штормового колдовства
...
Как только вы уменьшите скорость полёта таким образом, вы не сможете сделать это снова, до окончания короткого или продолжительного отдыха.`,
    ...
    'Аберрантный разум': {
      features: {
        1: ["Псионические заклинания", "Телепатическая речь"],
        6: ["Псионическое чародейство", "Психическая защита"],
        14: ["Откровение во плоти"],
        18: ["Искажающий взрыв"],
      },
      descriptions: {
        'Псионические заклинания': `1-й уровень, умение аберрантного разума
...
Заклинания
1
диссонирующий шёпот [dissonant whisper], расщепление разума [mind sliver], руки Хадара [arms of Hadar]
3
обнаружение мыслей [detect thoughts], умиротворение [calm emotions]
5
голод Хадара [hunger of Hadar], послание [sending]
7
призыв духа аберрации [summon aberration], Эвардовы чёрные щупальца [Evard’s black tentacles]
9
ментальная связь Рэри [Rary’s telepathic bond], телекинез [telekinesis]`,
        'Телепатическая речь': `1-й уровень, умение аберрантного разума
...
Телепатическая связь длится в течение количества минут, равному вашему уровню чародея. Она заканчивается раньше, если вы становитесь недееспособны или умираете, или если вы используете это умение, чтобы сформировать связь с другим существом.`,
        'Псионическое чародейство': `6-й уровень, умение аберрантного разума
Когда вы накладываете любое заклинание 1-го уровня или выше, используя своё умение «Псионические заклинания», вы можете наложить его, израсходовав ячейку заклинаний как обычно или потратив количество единиц чародейства, равное уровню заклинания. Если вы накладываете заклинание, используя единицы чародейства, то оно не требует вербального или соматического компонентов, а также материальных компонентов, если они не расходуются заклинанием.`,
        'Психическая защита': `6-й уровень, умение аберрантного разума
Вы получаете сопротивление урону психической энергией и совершаете с преимуществом спасброски против очарования или испуга.`,
        'Откровение во плоти': `14-й уровень, умение аберрантного разума
...
Ваше тело, вместе с любым снаряжением, которое вы носите или несете, становится скользким и податливым. Вы можете проходить через любое узкое пространство до 1 дюйма без протискивания и можете потратить 5 футов передвижения, чтобы вырваться из немагических пут или захвата.`,
        'Искажающий взрыв': `18-й уровень, умение аберрантного разума
...
Когда вы используете действие подобным образом, вы не сможете сделать это вновь, пока не закончите продолжительный отдых или не потратите 5 единиц чародейства на повторное использование этого умения.`,
    ...
    'Заводная душа': {
      features: {
        1: ["Заводная магия", "Восстановление баланса"],
        6: ["Бастион закона"],
        14: ["Медитация порядка"],
        18: ["Заводная кавалькада"],
      },
      descriptions: {
        'Заводная магия': `1-й уровень, умение заводной души
...
Заклинания
1
защита от зла и добра [protection from evil and good], сигнал тревоги [alarm]
3
малое восстановление [lesser restoration], подмога [aid]
5
защита от энергии [protection from energy], рассеивание магии [dispel magic]
7
призыв духа конструкта [summon construct], свобода перемещения [freedom of movement]
9
высшее восстановление [greater restoration], силовая стена [wall of force]
...
Вы и те, на кого воздействует ваша магия, слышат тиканье механизмов или звон часов.`,
        'Восстановление баланса': `1-й уровень, умение заводной души
...
Вы можете использовать это умение количество раз, равное вашему бонусу мастерства. Вы восстанавливаете все потраченные использования после окончания продолжительного отдыха.`,
        'Бастион закона': `6-й уровень, умение заводной души
...
Щит представлен количеством к8, равным количеству единиц чародейства, потраченных на его создание. Когда охраняемое существо получает урон, оно может потратить некоторое количество этих костей, уменьшив получаемый урон на результат броска потраченных костей.`,
        'Медитация порядка': `14-й уровень, умение заводной души
...
Когда вы используете бонусное действие подобным образом, вы не сможете сделать это вновь, пока не закончите продолжительный отдых или не потратите 5 единиц чародейства на повторное использование этого умения.`,
        'Заводная кавалькада': `18-й уровень, умение заводной души
